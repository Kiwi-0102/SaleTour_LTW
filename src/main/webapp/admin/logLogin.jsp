            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="row element-button">
                        <div class="col-sm-2">
                            <select class="form-select" style="display: flex;flex-direction: row-reverse;margin: 10px" aria-label="Default select example" onchange="navigateToLink(this.value)">
                                <option value="1">Tất cả log đăng nhập</option>
                                <option value="2">3 ngày gần đây</option>
                                <option value="3">7 ngày ngần đây</option>
                                <option value="4">30 ngày gần đây</option>
                                <option value="5">Đăng nhập thất bại</option>
                                <option value="6">Đăng nhập thành công</option>
                            </select>
                        </div>
                    </div>
...
<script>
    ...
    function navigateToLink(value) {
        switch (value) {
            case '1':
                window.location.href = '${pageContext.request.contextPath}/admin/LoginFailedLog?action=LoginFailedLog';
                break;
            case '2':
                window.location.href = '${pageContext.request.contextPath}/admin/LoginFailedLog?action=checkday&day=3';
                break;
            case '3':
                window.location.href = '${pageContext.request.contextPath}/admin/LoginFailedLog?action=checkday&day=7';
                break;
            case '4':
