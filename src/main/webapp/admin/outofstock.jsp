...
<section id="container">
    ...
    <section id="main-content">
        <div>
            <a style="margin-left: 1150px; display: none" href="addproduct.jsp" class="btn btn-success"><i class="material-icons">&#xE147;</i></a>
        </div>
        <!-- Edit Modal HTML -->
...
%>
                                    ...
                                    <tr id="tour<%=t.getId()%>">
                                        ...
                                        <td style="display: flex">
                                            ...
                                            <button class="btn btn-danger" onclick="setstatus(<%=t.getId()%>)" id="buttonSetStatus" data-toggle="modal">
                                    ...
                                    %>
                                    <tr>
                                        <td colspan="4">Không có sản phẩm nào bị ẩn đi.</td>
                                    </tr>
                                    <%
                                        }
                                    %>
    ...
    function setstatus(idTour){
        ...
        fetch("outofstock",{
            ...
            .then(response =>{
                ...
                var view = document.getElementById('tour'+idTour);
                view.classList.add('hiden')
                }
            })
    }
