...
<%
    ...
    User userdk = (User) request.getAttribute("userdk");
    ArrayList<Customer> dscus = (ArrayList<Customer>) request.getAttribute("dskh");
    Bill bill = (Bill) request.getAttribute("bill");
    Booking booking = (Booking) request.getAttribute("booking");

    String pay = bill.getPaymentMethod();
    String date = booking.getDateStart();
    Integer quantity = booking.getNumAdult();
    int quatity = (quantity != null) ? quantity.intValue() : 1;

    Integer quantitycc = booking.getNumChildren();
