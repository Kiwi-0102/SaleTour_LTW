...
public class RegisterController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            if (!email.matches("^[a-zA-Z0-9._%+-]{5,}@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,}$")) {
            ...
            if (!password.matches("^(?=.*[A-Z])(?=.*[@$!%*?&])[A-Za-z\\d@$!%*?&]{8,}$")) {
                err = "Mật khẩu phải có ít nhất 1 chữ viết hoa, 1 ký tự đặc biệt và dài hơn 8 ký tự.";
                logs.insert(new Log(Log.INFO, -1, PublicIPFetcher.getPublicIP(), Nation(request), "Đăng kí tài khoản không thành công: \n" + "Lỗi" + err, createdAt, 0));
                request.setAttribute("err", "Mật khẩu phải có ít nhất 1 chữ viết hoa, 1 ký tự đặc biệt và dài hơn 8 ký tự.");
                request.getRequestDispatcher("./register.jsp").forward(request, response);
                return;
            }
            ...
            // Nếu không có lỗi nào, tiếp tục gửi OTP và xử lý đăng ký
            ...
            try {
                ...
                message.setFrom(new InternetAddress("servicetournest@gmail.com"));
                ...
                String htmlContent = String.format(
                        "<html>" +
                                ...
                                "<p style=\"font-size:30px;color:#00d8fe;text-align:center;\">%d</p>" +
                                "<p>Xin cảm ơn.</p>" +
