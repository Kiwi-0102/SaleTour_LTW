...
ALTER TABLE `Booking`
    ADD CONSTRAINT `fk_userbk_id` FOREIGN KEY (`userId`) REFERENCES `users` (`id`),
    ADD CONSTRAINT `fk_tourbk_id` FOREIGN KEY (`tourId`) REFERENCES `tours` (`id`);
...
ALTER TABLE `bills`
    ADD CONSTRAINT `fk_Booking_Id` FOREIGN KEY (`bookingId`) REFERENCES `booking` (`id`);
...
ALTER TABLE `customer`
    ADD CONSTRAINT `fk_billId` FOREIGN KEY (`billId`) REFERENCES `bills` (`id`);
...
INSERT INTO `tours` (`region`, `discountId`, `name`, `image`, `price`, `startTime`, `duration`, `schedule`, `description`,`quantity`)
VALUES
	...
	Chuyến đi kết thúc khi bạn trở về Cần Thơ. Chuyến đi từ Cần Thơ đến Châu Đốc sẽ mang đến cho bạn những trải nghiệm tuyệt vời về văn hóa, thiên nhiên và cảnh quan của miền Tây Nam Bộ Việt Nam.',50),
    ('Miền Nam', 1, 'Tp. Hồ Chí Minh - Phú Quốc', '2.jpg', 4190000, 'hằng ngày', '3 ngày 2 đêm', 'Ngày 1: Khám phá bãi biển và thưởng thức ẩm thực địa phương - Ngày 2: Khám phá vườn quốc gia và làng chài - Ngày 3: Thư giãn và tận hưởng bãi biển', 'Chuyến đi du lịch đến Phú Quốc là một trải nghiệm tuyệt vời để khám phá vẻ đẹp tự nhiên và văn hóa độc đáo của hòn đảo này. Phú Quốc nổi tiếng với các bãi biển tuyệt đẹp, cát trắng mịn và nước biển trong xanh. Du khách có thể thả mình trong làn nước biển mát lạnh, tắm nắng trên bãi cát và tham gia các hoạt động thể thao nước như lướt ván buồm, lặn biển hoặc câu cá.
	...
	Dù bạn muốn thư giãn trên bãi biển, khám phá thiên nhiên hoang dã hay tìm hiểu văn hóa địa phương, chuyến đi đến Phú Quốc sẽ mang đến cho bạn những trải nghiệm đáng nhớ và thú vị.',50),
    ('Miền Nam', 1, 'Cần Thơ - Cồn Sơn - Cồn Ấu', '3.jpg', 5390000, 'hằng ngày', '4 ngày 3 đêm', 'Ngày 1: Cần Thơ / Khám phá thành phố và thưởng thức ẩm thực địa phương - Ngày 2: Cồn Sơn - Ngày 3: Cồn Ấu - Ngày 4: Cần Thơ / Tham quan cuối cùng và kết thúc chuyến đi', 'Tour Cần Thơ - Cồn Sơn - Cồn Ấu là một hành trình thú vị để khám phá vẻ đẹp thiên nhiên và văn hóa đặc trưng của miền Tây Nam Bộ Việt Nam. Trong tour này, bạn sẽ được tận hưởng không khí yên bình của sông nước, trải nghiệm cuộc sống đồng bằng và khám phá các đảo nhỏ.
	...
	Tour Cần Thơ - Cồn Sơn - Cồn Ấu sẽ mang đến cho bạn những trải nghiệm đáng nhớ và tạo ra những kỷ niệm đáng giá trong hành trình khám phá miền Tây Nam Bộ Việt Nam.',50),
	...
	Mỹ Tho và Bến Tre mang đến cho du khách một trải nghiệm đầy thú vị về vẻ đẹp thiên nhiên, văn hóa và ẩm thực miền Nam Việt Nam.',50),
	...
	Sau hai ngày trải nghiệm, bạn sẽ trở lại thành phố Hồ Chí Minh với những kỷ niệm và kiến thức mới về lịch sử và văn hóa đặc biệt của Củ Chi',50),
	...
	Điểm đến đầu tiên là Tây Ninh, nơi có Đền Cao Đài - trụ sở chính của Đạo Cao Đài, một tôn giáo độc đáo kết hợp yếu tố từ các tôn giáo khác nhau. Du khách có thể tham quan và tìm hiểu về tôn giáo này thông qua lễ nghi và kiến trúc đặc trưng của đền.',50),
    ('Miền Nam', 1, 'Đồng Tháp - Mộc Hóa', '3.jpg', 6790000, 'hằng ngày', '4 ngày 3 đêm', 'Ngày 1: Đến Đồng Tháp - Ngày 2: Khám phá Đồng Tháp - Ngày 3: Đi Mộc Hóa - Ngày 4: Trở về thành phố Hồ Chí Minh', 'Tour Đồng Tháp - Mộc Hóa là chuyến hành trình để khám phá hai điểm đến hấp dẫn ở miền Nam Việt Nam.',50),
    ('Miền Nam', 1, 'Long An - Bến Lức', '8.jpg', 2790000, 'hằng ngày', '2 ngày 1 đêm', 'Ngày 1: Rời khỏi thành phố Hồ Chí Minh và đi đến Long An. - Ngày 2: Ăn sáng tại khách sạn và chuẩn bị rời khỏi Long An.', 'Chuyến đi Long An - Bến Lức là một hành trình để khám phá vẻ đẹp tự nhiên, văn hóa và ẩm thực của vùng Đồng Bằng Sông Cửu Long.',50),
    ('Miền Nam', 1, 'Tiền Giang - Cai Lậy', '9.jpg', 3590000, 'hằng ngày', '3 ngày 2 đêm', 'Ngày 1: Đến Tiền Giang - Ngày 2: Khám phá Cái Lậy - Ngày 3: Trở về thành phố Hồ Chí Minh', 'Tour Tiền Giang - Cái Lậy là một hành trình khám phá vùng đồng bằng sông nước phong cảnh tại miền Nam Việt Nam. ',50),
    ('Miền Nam', 1, 'Bình Dương - Suối Tiên', '10.jpg', 4490000, 'hằng ngày', '4 ngày 3 đêm', 'Ngày 1: Buổi sáng: Rời khỏi thành phố Hồ Chí Minh và đến Bình Dương - Ngày 2: Buổi sáng: Tham quan Khu du lịch Suối Tiên ở thành phố Hồ Chí Minh - Ngày 3: Buổi sáng: Tham quan Khu du lịch Đại Nam Văn Hiến - Ngày 4: Trở về thành phố Hồ Chí Minh', 'Chuyến đi Bình Dương - Suối Tiên là một hành trình thú vị để khám phá vùng đất Bình Dương và tận hưởng các hoạt động giải trí tại khu du lịch Suối Tiên.',50),
    ('Miền Nam', 1, 'Bình Phước - Thác Ma Thiên Lân', '11.jpg', 2529000, 'hằng ngày', '2 ngày 1 đêm', 'Ngày 1: . . . - Ngày 2: . . . ', 'Bình Phước là một tỉnh ở miền Nam Việt Nam, nổi tiếng với cảnh quan đồng bằng sông nước và rừng núi. Thác Ma Thiên Lân là một điểm đến đẹp và hoang sơ nằm ở Bình Phước, với thác nước hùng vĩ và cảnh quan thiên nhiên tuyệt đẹp. Du khách có thể tận hưởng viễn cảnh, leo núi và tắm mát dưới thác, mang lại trải nghiệm đáng nhớ.',50),
    ('Miền Nam', 1, 'Đồng Nai - Khu du lịch Bửu Long', '12.jpg', 7082000, 'hằng ngày', '3 ngày 4 đêm', 'Ngày 1: . . . - Ngày 2: . . .  - Ngày 3: . . .', 'Đồng Nai là một tỉnh nằm ở miền Nam Việt Nam, nổi tiếng với cảnh quan thiên nhiên đa dạng. Khu du lịch Bửu Long là một điểm đến phổ biến ở Đồng Nai, với hồ nước trong xanh và cảnh quan tuyệt đẹp. Du khách có thể tham quan các ngôi đền, thưởng thức không gian yên bình, và tận hưởng hoạt động như đi thuyền trên hồ và tham gia câu cá, mang đến những trải nghiệm thú vị.',50),
    ('Miền Nam', 1, 'Vũng Tàu - Hồ Tràm', '13.jpg', 4484000, 'hằng ngày', '3 ngày 2 đêm', 'Ngày 1: . . . - Ngày 2: . . .  - Ngày 3: . . .', 'Vũng Tàu là một thành phố ven biển nằm ở miền Nam Việt Nam, được biết đến với bãi biển đẹp và không khí biển trong lành. Hồ Tràm là một điểm đến phổ biến tại Vũng Tàu, với bãi biển dài và cát mịn. Du khách có thể thư giãn trên bãi biển, tắm biển và tham gia vào các hoạt động như lướt sóng, chèo thuyền kayak, mang lại những trải nghiệm tuyệt vời.',50),
    ('Miền Nam', 1, 'Tp Hồ Chí Minh - Vũng Tàu', '14.jpg', 5967000, 'hằng ngày', '4 ngày 3 đêm', 'Ngày 1: . . . - Ngày 2: . . .  - Ngày 3: . . . - Ngày 4: . . .', 'Vũng Tàu là một thành phố ven biển nằm ở miền Nam Việt Nam, được biết đến với bãi biển đẹp và không khí biển trong lành.',50),
    ('Miền Nam', 1, 'Tp Hồ Chí Minh - Côn Đảo', '15.jpg', 2853000, 'hằng ngày', '2 ngày 1 đêm', 'Ngày 1: . . . - Ngày 2: . . . ', 'Côn Đảo là một quần đảo nằm ở miền Nam Việt Nam, được biết đến với vẻ đẹp hoang sơ và biển xanh tuyệt đẹp. Nơi đây có những bãi biển trắng mịn, nước biển trong xanh và rừng nguyên sinh tươi tốt. Du khách có thể tham gia vào các hoạt động như tắm biển, lặn biển để khám phá động san hô và tham quan các di tích lịch sử như Nhà tù Côn Đảo và Bảo tàng Côn Đảo. Côn Đảo cũng nổi tiếng với ngôi chùa Quan Âm cao nhất Việt Nam, nơi du khách có thể tìm hiểu về đạo Phật và tận hưởng không gian yên bình.',50),
...
Chợ Nổi Cái Răng là một điểm đến thu hút du khách bởi không chỉ là nơi mua sắm và trao đổi hàng hóa, mà còn là một cái nhìn sâu sắc vào cuộc sống và văn hóa dân gian của người dân miền Tây Nam Bộ.',50),
-- 71-140
    ('Miền Trung', 1, 'Quảng Bình - Kẻ Gỗ', '71.png', 1990000, 'hằng ngày', '2 ngày 2 đêm', 'Ngày 1: Quảng Bình - Ngày 2: Kẻ Gỗ'
    ,'Quảng Bình và Kẻ Gỗ là hai điểm đến du lịch nổi tiếng ở miền Trung Việt Nam với vẻ đẹp tự nhiên, văn hóa độc đáo và ẩm thực hấp dẫn.',50),
    ...
    ,'Đà Nẵng và Hội An là hai điểm đến du lịch nổi tiếng ở miền Trung Việt Nam với vẻ đẹp tự nhiên, văn hóa độc đáo và ẩm thực hấp dẫn.',50),
    ('Miền Trung', 1, 'Đà Nẵng - Huế - Quảng Bình', '73.png', 2990000, 'hằng ngày', '3 ngày 2 đêm', 'Ngày 1: Đà Nẵng - Ngày 2: Huế - Ngày 3: Quảng Bình'
    ,'Đà Nẵng, Huế, Quảng Bình là ba điểm đến du lịch nổi tiếng ở miền Trung Việt Nam với vẻ đẹp tự nhiên, văn hóa độc đáo và ẩm thực hấp dẫn.',50),
    ('Miền Trung', 1, ' Huế - Đà Nẵng - Hội An', '74.png', 2990000, 'hằng ngày', '3 ngày 2 đêm', 'Ngày 1: Huế - Ngày 2: Đà Nẵng - Ngày 3: Hội An'
    ,'Đà Nẵng, Huế, Hội An là ba điểm đến du lịch nổi tiếng ở miền Trung Việt Nam với vẻ đẹp tự nhiên, văn hóa độc đáo và ẩm thực hấp dẫn.',50),
    ('Miền Trung', 1, 'Quy Nhơn - Phú Yên', '75.png', 1990000, 'hằng ngày', '2 ngày 2 đêm', 'Ngày 1: Qui Nhơn- Ngày 2: Phú Yên'
    ,'Quy Nhơn - Phú Yên là hai điểm đến du lịch nổi tiếng ở miền Trung Việt Nam với vẻ đẹp tự nhiên, văn hóa độc đáo và ẩm thực hấp dẫn.',50),
    ('Miền Trung', 1, 'Quảng Nam - Cù Lao Chàm', '76.png', 1990000, 'hằng ngày', '2 ngày 2 đêm', 'Ngày 1: Quảng Nam - Ngày 2: Cù Lao Chàm'
    ,'Quảng Nam, Cù Lao Chàm là ba điểm đến du lịch nổi tiếng ở miền Trung Việt Nam với vẻ đẹp tự nhiên, văn hóa độc đáo và ẩm thực hấp dẫn.',50),
    ('Miền Trung', 1, 'Gia Lai - Kon Tum', '77.png', 1990000, 'hằng ngày', '2 ngày 1 đêm', 'Ngày 1: Gia Lai - Ngày 2: Kon Tum'
    ,'Gia Lai, Kon Tum là hai điểm đến du lịch nổi tiếng ở miền Trung Việt Nam với vẻ đẹp tự nhiên, văn hóa độc đáo và ẩm thực hấp dẫn.',50),
    ('Miền Trung', 1, 'Nha Trang - Đảo Hoa Lan', '78.png', 1990000, 'hằng ngày', '2 ngày 1 đêm', 'Ngày 1: Nha Trang- Ngày 2: Đảo Hoa Lan'
    ,'Nha Trang, Đảo Hoa Lan là hai điểm đến du lịch nổi tiếng ở miền Trung Việt Nam với vẻ đẹp tự nhiên, văn hóa độc đáo và ẩm thực hấp dẫn.',50),
    ('Miền Trung', 1, 'Quảng Bình - Đèo Ngang', '79.png', 1990000, 'hằng ngày', '2 ngày 1 đêm', 'Ngày 1: Quảng Bình- Ngày 2: Đèo Ngang'
    ,'Quảng Bình - Đèo Ngang là hai điểm đến du lịch nổi tiếng ở miền Trung Việt Nam với vẻ đẹp tự nhiên, văn hóa độc đáo và ẩm thực hấp dẫn.',50),
    ...
    ,'Đà Nẵng - Huế - Phong Nha là ba điểm đến du lịch nổi tiếng ở miền Trung Việt Nam với vẻ đẹp tự nhiên, văn hóa độc đáo và ẩm thực hấp dẫn.',50),
    ('Miền Trung', 1, 'Pleiku - Kon Tum', '81.png', 2990000, 'hằng ngày', '3 ngày 3 đêm', 'Ngày 1: Pleiku- Ngày 2: Gia Lai- Ngày 3: Kon Tum'
    ,'Pleiku - Gia Lai - Kon Tum là ba điểm đến du lịch nổi tiếng ở miền Trung Việt Nam với vẻ đẹp tự nhiên, văn hóa độc đáo và ẩm thực hấp dẫn.',50),
    ('Miền Trung', 1, 'Tam Kỳ - Quảng Ngãi', '82.png', 1990000, 'hằng ngày', '2 ngày 2 đêm', 'Ngày 1: Tam Kỳ - Ngày 2: Quãng Ngãi'
    ,'Tam Kỳ - Quảng Ngãi là ba điểm đến du lịch nổi tiếng ở miền Trung Việt Nam với vẻ đẹp tự nhiên, văn hóa độc đáo và ẩm thực hấp dẫn.',50),
    ('Miền Trung', 1, 'Cửa Lò - Nghệ An', '83.png', 2990000, 'hằng ngày', '3 ngày 3 đêm', 'Ngày 1: Cửa Lò- Ngày 2: Nghệ An- Ngày 3: Về lại Nghệ An'
    ,'Cửa Lò - Nghệ An là hai điểm đến du lịch nổi tiếng ở miền Trung Việt Nam với vẻ đẹp tự nhiên, văn hóa độc đáo và ẩm thực hấp dẫn.',50),
    ...
    ,'Bình Thuận - Phan Thiết là hai điểm đến du lịch nổi tiếng ở miền Trung Việt Nam với vẻ đẹp tự nhiên, văn hóa độc đáo và ẩm thực hấp dẫn.',50),
    ...
    ,'Tam Đảo - Vĩnh Phúc là hai điểm đến du lịch nổi tiếng ở miền Trung Việt Nam với vẻ đẹp tự nhiên, văn hóa độc đáo và ẩm thực hấp dẫn.',50),
    ...
    ,'Tràng An - Ninh Bình là hai điểm đến du lịch nổi tiếng ở miền Trung Việt Nam với vẻ đẹp tự nhiên, văn hóa độc đáo và ẩm thực hấp dẫn.',50),
    ...
    ,'Đà Nẵng - Bà Nà Hills là hai điểm đến du lịch nổi tiếng ở miền Trung Việt Nam với vẻ đẹp tự nhiên, văn hóa độc đáo và ẩm thực hấp dẫn.',50),
    ...
    ,'Đà Nẵng - Ngũ Hành Sơn - Hội An ba điểm đến du lịch nổi tiếng ở miền Trung Việt Nam với vẻ đẹp tự nhiên, văn hóa độc đáo và ẩm thực hấp dẫn.',50),
    ('Miền Trung', 1, 'Đà Nẵng - Huế', '89.png', 2990000, 'hằng ngày', '3 ngày 3 đêm', 'Ngày 1: Đà Nẵng- Ngày 2: Ngũ Hành Sơn- Ngày 3: Huế'
    ,'Đà Nẵng - Ngũ Hành Sơn - Huế là hai điểm đến du lịch nổi tiếng ở miền Trung Việt Nam với vẻ đẹp tự nhiên, văn hóa độc đáo và ẩm thực hấp dẫn.',50),
    ('Miền Trung', 1, 'Huế - Đà Nẵng', '90.png', 2990000, 'hằng ngày', '3 ngày 3 đêm', 'Ngày 1: Huế- Ngày 2: Chùa Thiện Mụ- Ngày 3: Đà Nẵng','Huế là một nơi tuyệt đẹp',50),
    ...
    ,'Nha Trang - Vinpearl Land - Vinpearl Safari - Đà Nẵng là bốn điểm đến du lịch nổi tiếng ở miền Trung Việt Nam với vẻ đẹp tự nhiên, văn hóa độc đáo và ẩm thực hấp dẫn.',50),
    ...
    ,'Nha Trang - Vinpearl Land - Vinpearl Safari - Hội An là bốn điểm đến du lịch nổi tiếng ở miền Trung Việt Nam với vẻ đẹp tự nhiên, văn hóa độc đáo và ẩm thực hấp dẫn.',50),
    ('Miền Trung', 1, 'Nha Trang - Hội An', '93.png', 2990000, 'hằng ngày', '3 ngày 3 đêm', 'Ngày 1: Nha Trang- Ngày 2: Vinpearl Land- Ngày 3: Hội An'
    ,'Nha Trang - Vinpearl Land - Hội An là ba điểm đến du lịch nổi tiếng ở miền Trung Việt Nam với vẻ đẹp tự nhiên, văn hóa độc đáo và ẩm thực hấp dẫn.',50),
    ...
    ,' Đà Nẵng - Ngũ Hành Sơn - Bà Nà Hills là ba điểm đến du lịch nổi tiếng ở miền Trung Việt Nam với vẻ đẹp tự nhiên, văn hóa độc đáo và ẩm thực hấp dẫn.',50),
    ...
    ,'Đà Nẵng - Huế - Hội An - Bà Nà Hills là bốn điểm đến du lịch nổi tiếng ở miền Trung Việt Nam với vẻ đẹp tự nhiên, văn hóa độc đáo và ẩm thực hấp dẫn.',50),
    ...
    ,' Đà Nẵng - Ngũ Hành Sơn - Bà Nà Hills - Chùa Thiên Mụ - Cù Lao Chàm là năm điểm đến du lịch nổi tiếng ở miền Trung Việt Nam với vẻ đẹp tự nhiên, văn hóa độc đáo và ẩm thực hấp dẫn.',50),

    ('Miền Trung', 1, 'Đà Nẵng - Cù Lao Chàm', '97.jpg', 1990000, 'hằng ngày', '2 ngày 3 đêm', 'Ngày 1: Đà Nẵng- Ngày 2: Cù Lao Chàm'
    ,' Đà Nẵng - Cù Lao Chàm là hai điểm đến du lịch nổi tiếng ở miền Trung Việt Nam với vẻ đẹp tự nhiên, văn hóa độc đáo và ẩm thực hấp dẫn.',50),
    ('Miền Trung', 1, 'Huế - Cù Lao Chàm', '98.jpg', 2990000, 'hằng ngày', '3 ngày 2 đêm', 'Ngày 1: Huế- Ngày 2: Chùa Thiện Mụ- Ngày 3: Cù Lao Chàm'
    ,' Huế - Chùa Thiên Mụ - Cù Lao Chàm  là ba điểm đến du lịch nổi tiếng ở miền Trung Việt Nam với vẻ đẹp tự nhiên, văn hóa độc đáo và ẩm thực hấp dẫn.',50),

    ('Miền Trung', 1, 'Huế - Cù Lao Chàm', '99.jpg', 1990000, 'hằng ngày', '2 ngày 1 đêm', 'Ngày 1: Huế- Ngày 2: Cù Lao Chàm'
    ,' Huế - Cù Lao Chàm là hai điểm đến du lịch nổi tiếng ở miền Trung Việt Nam với vẻ đẹp tự nhiên, văn hóa độc đáo và ẩm thực hấp dẫn.',50),

    ('Miền Trung', 1, 'Nha Trang - Vinpearl Land', '100.jpg', 1990000, 'hằng ngày', '2 ngày 1 đêm', 'Ngày 1: Nha Trang- Ngày 2: Vinpearl Land'
    ,' Nha Trang - Vinpearl Land là hai điểm đến du lịch nổi tiếng ở miền Trung Việt Nam với vẻ đẹp tự nhiên, văn hóa độc đáo và ẩm thực hấp dẫn.',50),
    ('Miền Trung', 1, 'Nha Trang - Vinpearl Safari', '101.jpg', 1990000, 'hằng ngày', '2 ngày 1 đêm', 'Ngày 1: Nha Trang- Ngày 2: Vinpearl Safari'
    ,' Nha Trang - Vinpearl Safari là hai điểm đến du lịch nổi tiếng ở miền Trung Việt Nam với vẻ đẹp tự nhiên, văn hóa độc đáo và ẩm thực hấp dẫn.',50),
    ...
    ,' Nha Trang - Vinpearl Land là ba điểm đến du lịch nổi tiếng ở miền Trung Việt Nam với vẻ đẹp tự nhiên, văn hóa độc đáo và ẩm thực hấp dẫn.',50),
    ('Miền Trung', 1, 'Quy Nhơn - Eo Gió', '103.jpg', 1990000, 'hằng ngày', '2 ngày 1 đêm', 'Ngày 1: Quy Nhơn- Ngày 2: Eo Gió'
    ,' Quy Nhơn - Eo Gió Land là hai điểm đến du lịch nổi tiếng ở miền Trung Việt Nam với vẻ đẹp tự nhiên, văn hóa độc đáo và ẩm thực hấp dẫn.',50),
    ('Miền Trung', 1, 'Quy Nhơn - Kỳ Co', '104.jpg', 1990000, 'hằng ngày', '2 ngày 1 đêm', 'Ngày 1: Quy Nhơn- Ngày 2: Kỳ Co'
    ,' Quy Nhơn - Kỳ Co  là hai điểm đến du lịch nổi tiếng ở miền Trung Việt Nam với vẻ đẹp tự nhiên, văn hóa độc đáo và ẩm thực hấp dẫn.',50),
    ('Miền Trung', 1, 'Quy Nhơn - Gành Đá Dĩa', '105.jpg', 1990000, 'hằng ngày', '2 ngày 1 đêm', 'Ngày 1: Quy Nhơn- Ngày 2: Gành Đá Dĩa'
    ,' Quy Nhơn - Gành Đá Dĩa là hai điểm đến du lịch nổi tiếng ở miền Trung Việt Nam với vẻ đẹp tự nhiên, văn hóa độc đáo và ẩm thực hấp dẫn.',50),
    ...
    ,' chuyến du lịch từ Đà Nẵng tới Hội An sẽ mang đến cho du khách những điểm đến du lịch nổi tiếng ở miền Trung Việt Nam với vẻ đẹp tự nhiên, văn hóa độc đáo và ẩm thực hấp dẫn.',50),
    ('Miền Trung', 1, 'Đà Nẵng - Cù Lao Chàm', '124.jpg', 990000, 'hằng ngày', '1 ngày 1 đêm', 'Sáng Ngày 1: Đà Nẵng- Chiều Ngày 1: Cù Lao Chàm'
    ,' chuyến du lịch từ Đà Nẵng tới Cù Lao Chàm sẽ mang đến cho du khách những điểm đến du lịch nổi tiếng ở miền Trung Việt Nam với vẻ đẹp tự nhiên, văn hóa độc đáo và ẩm thực hấp dẫn.',50),
    ('Miền Trung', 1, 'Huế - Đại Nội', '125.jpg', 990000, 'hằng ngày', '1 ngày 1 đêm', 'Sáng Ngày 1: Huế- Chiều Ngày 1: Đại Nội'
    ,' chuyến du lịch từ Huế tới Đại Nội sẽ mang đến cho du khách những điểm đến du lịch nổi tiếng ở miền Trung Việt Nam với vẻ đẹp tự nhiên, văn hóa độc đáo và ẩm thực hấp dẫn.',50),
    ('Miền Trung', 1, 'Huế - Đại Nội', '126.jpg', 990000, 'hằng ngày', '1 ngày 1 đêm', 'Sáng Ngày 1: Huế- Chiều Ngày 1: Chùa Thiên Mụ'
    ,' chuyến du lịch từ Huế tới Chùa Thiên Mụ sẽ mang đến cho du khách những điểm đến du lịch nổi tiếng ở miền Trung Việt Nam với vẻ đẹp tự nhiên, văn hóa độc đáo và ẩm thực hấp dẫn.',50),
    ...
    ,' Phú Yên - Gành Đá Dĩa là hai điểm đến du lịch nổi tiếng ở miền Trung Việt Nam với vẻ đẹp tự nhiên, văn hóa độc đáo và ẩm thực hấp dẫn.',50),
    ('Miền Trung', 1, 'Phú Yên - Vịnh Vũng Rô', '133.jpg', 1990000, 'hằng ngày', '2 ngày 2 đêm', 'Ngày 1: Phú Yên- Ngày 2: Vịnh Vũng Rô'
    ,' Phú Yên - Vịnh Vũng Rô là hai điểm đến du lịch nổi tiếng ở miền Trung Việt Nam với vẻ đẹp tự nhiên, văn hóa độc đáo và ẩm thực hấp dẫn.',50),
    ('Miền Trung', 1, 'Đà Nẵng - Hội An', '134.jpg', 1990000, 'hằng ngày', '2 ngày 2 đêm', 'Ngày 1: Đà Nẵng- Ngày 2: Hội An'
    ,' Đà Nẵng - Hội An là hai điểm đến du lịch nổi tiếng ở miền Trung Việt Nam với vẻ đẹp tự nhiên, văn hóa độc đáo và ẩm thực hấp dẫn.',50),
    ('Miền Trung', 1, 'Đà Nẵng - Huế', '135.jpg', 1990000, 'hằng ngày', '2 ngày 2 đêm', 'Ngày 1: Đà Nẵng- Ngày 2: Huế'
    ,' Đà Nẵng - Huế là hai điểm đến du lịch nổi tiếng ở miền Trung Việt Nam với vẻ đẹp tự nhiên, văn hóa độc đáo và ẩm thực hấp dẫn.',50),
    ('Miền Trung', 1, 'Hội An - Đà Nẵng', '136.jpg', 1990000, 'hằng ngày', '2 ngày 2 đêm', 'Ngày 1: Hội An- Ngày 2: Đà Nẵng'
    ,' Hội An, Đà Nẵng là hai điểm đến du lịch nổi tiếng ở miền Trung Việt Nam với vẻ đẹp tự nhiên, văn hóa độc đáo và ẩm thực hấp dẫn.',50),
...
-- 141 -->210----------------------------------->
    ('Miền Bắc', 1, 'Hà Nội - Yên Tử ','141.png', 9399000, 'Hàng Ngày ', '4 ngày 3 đêm ', 'Hà Nội - Hạ Long - Ninh Bình - Yên Tử ', ' Tham quan vườn hoa Bãi Đá Sông Hồng (hoặc Thung Lũng Hoa Hồ Tây)- Du ngoạn vịnh Hạ Long - một trong 7 kỳ quan thiên nhiên mới của thế giới. Chiêm ngưỡng động Thiên Cung, các hòn Đỉnh Hương - Trống Mái (Gà Chọi)- Chó Đá- Tham quan Động Am Tiên (Tuyệt Tình Cốc Ninh Bình)',50),

    ('Miền Bắc', 1, 'Hà Nội - Bắc Ninh ','142.png', 1599000, 'Hàng Ngày ', '4 ngày 3 đêm ', 'Hà Nội - Yên Tử - Hạ Long - Bắc Ninh ', 'Thăm quan quần thể di tích Yên Tử nơi đất phật linh thiêng .Thăm quan ngắm cảnh vịnh Hạ Long một trong 7 kỳ quan. Thỏa sức tắm biển bãi Cháy một trong những bãi biển nhân tạo đẹp nhất của vịnh Hạ Long. Thỏa sức ngắm nhìn vịnh Hạ Long từ trên cao. Khám phá công viên rồng địa điểm nhiều khu vui chơi đẳng cấp Tuần Châu. Ngắm nhìn cảng tàu quốc tế độc đáo. Trải nghiệm công trình cáp treo vượt biển đẳng cấp',50),

    ('Miền Bắc', 1, 'Hà Nội - Cao Bằng ','143.png', 8499000, 'Hàng Ngày ', '3 ngày 2 đêm ', 'Hà Nội - Hà Giang - Cao Bằng',' thành phố lịch sử với những con phố nhộn nhịp và di tích lịch sử hùng vĩ. Du khách sẽ đắm chìm trong vẻ đẹp huyền bí của Hà Giang, khám phá những cung đường ngoằn nghèo giữa đồng bát ngát. Tới Cao Bằng, vùng đất trù phú với những thác Bản Giốc hùng vĩ và đỉnh núi Cốc Bó, tour du lịch này hứa hẹn mang lại trải nghiệm độc đáo, kết hợp giữa văn hóa đậm đà và khám phá thiên nhiên tuyệt vời.',50),

    ('Miền Bắc', 1, 'Hà Nội - Đồng Văn ','144.png', 5799000, 'Hàng Ngày ', '3 ngày 2 đêm ', 'Hà Nội - Hà Giang - Đồng Văn ', 'Hành trình du lịch từ Hà Nội đến Hà Giang và Cao Bằng là một chuyến phiêu lưu hấp dẫn, đưa bạn đến khám phá vẻ đẹp huyền bí của núi rừng Tây Bắc Việt Nam. Từ thủ đô lịch sử Hà Nội, bạn sẽ bắt đầu hành trình đến vùng núi cao Hà Giang, nơi có cảnh đồng cỏ bát ngát và đỉnh núi hùng vĩ. Sau đó, hành trình tiếp tục đến Cao Bằng, với cảnh đẹp tự nhiên hùng vĩ của thác Bản Giốc và hồ Ba Bể. Mỗi dấu chân của bạn là một câu chuyện mới trong cuộc phiêu lưu này.',50),

    ('Miền Bắc', 1, 'Hồ Chí Minh - Yên Tử - Sapa ','145.png', 4199000, 'Hàng Ngày ', '4 ngày 3 đêm ', 'Sài Gòn - Hà Nội - Sapa - Yên Tử ', 'Tour du lịch Hạ Long - Yên Tử - Sapa là hành trình kỳ thú đưa du khách khám phá những vẻ đẹp hùng vĩ và thiên nhiên tuyệt vời của Việt Nam. Bắt đầu từ Hạ Long, quý khách sẽ đắm chìm trong vịnh biển tuyệt vời và tham gia các hoạt động thú vị. Tiếp theo, hành trình dẫn đến Yên Tử, nơi linh thiêng và huyền bí, thu hút những tâm hồn tìm kiếm bình yên. Cuối cùng, Sapa mang đến trải nghiệm với những cánh đồng bậc thang hùng vĩ và vùng núi tuyết phủ, tạo nên kí ức đẹp khó quên.',50),

    ('Miền Bắc', 1, 'Hạ Long - Fansipan ','146.png', 8499000, 'Hàng Ngày ', '4 ngày 3 đêm ', 'Vịnh Hạ Long - Yên Tử - Sapa - Fansipan ', 'Hành trình du lịch đưa bạn đến những địa danh nổi tiếng và tuyệt vời của Việt Nam. Bắt đầu từ Hạ Long, bạn sẽ ngỡ ngàng trước vẻ đẹp huyền bí của vịnh và những tảng đá độc đáo. Tiếp theo, hành trình dẫn bạn lên đỉnh Yên Tử, nơi linh thiêng với những ngôi chùa cổ kính và không khí tĩnh lặng. Cuối cùng, Sapa là điểm dừng cuối cùng, nơi bạn sẽ bị quyến rũ bởi những thửa ruộng bậc thang tuyệt vời và vùng núi hùng vĩ. Đây sẽ là chuyến phiêu lưu đầy ấn tượng và trải nghiệm sâu sắc với văn hóa và thiên nhiên Việt Nam.',50),

    ('Miền Bắc', 1, 'Tp Hồ Chí Minh - Hạ Long ','147.png', 8999000, 'Hàng Ngày ', '4 ngày 3 đêm ', 'Sài Gòn - Hà Nội - Lào Cai - Hạ Long ', 'Tour du lịch bắt đầu từ thành phố Hạ Long, nơi bạn sẽ đắm chìm trong vẻ đẹp huyền bí của vịnh Hạ Long, được UNESCO công nhận. Tiếp theo, hành trình hướng về Yên Tử, nơi linh thiêng và tâm linh hòa quyện, với chân đèo Phố Cô và chùa Trân Quốc. Cuối cùng, tour dẫn bạn đến Sapa, thiên đường nằm trong mảnh đất tuyệt vời của dãy núi Hoàng Liên, với cảnh sắc hùng vĩ và văn hóa độc đáo của các dân tộc thiểu số. Đây sẽ là chuyến hành trình tuyệt vời, đầy ấn tượng và trải nghiệm đa dạng.',50),

    ('Miền Bắc', 1, 'Hà Nội - Yên Tử','148.png', 9299000, 'Hàng Ngày ', '3 ngày 2 đêm ', 'Hà Nội - Yên Tử ', 'Tour du lịch kết hợp giữa Thành phố Hồ Chí Minh năng động và Hà Nội lịch lãm cùng với đỉnh núi thiêng Yên Tử tạo nên một hành trình đa dạng và phong cách. Trải nghiệm sự hối hả của cuộc sống đô thị tại TP.Hồ Chí Minh, khám phá văn hóa lâu dài của Hà Nội qua các di tích lịch sử và ẩm thực độc đáo. Kết thúc hành trình là cuộc phiêu lưu tâm linh tại Yên Tử, với khung cảnh thiên nhiên hùng vĩ và không khí trấn an.',50),

    ('Miền Bắc', 1, 'Hà Nội - Tràng An ','149.png', 9499000, 'Hàng Ngày ', '4 ngày 3 đêm ', 'Hà Nội - Hạ Long - Ninh Bình - Tràng An ', 'Tour du lịch từ Hà Nội đến Hạ Long, Ninh Bình và Tràng An là một hành trình đầy phấn khích, mang đến trải nghiệm đa dạng văn hóa và thiên nhiên. Từ thủ đô lịch sử Hà Nội, bạn sẽ bắt đầu hành trình đến vịnh Hạ Long, nơi những hòn đảo đá vôi nổi tiếng nổi bật giữa biển xanh bát ngát. Tiếp theo, Ninh Bình là điểm đến tuyệt vời với những cánh đồng lúa mênh mông và các di tích lịch sử. Tour kết thúc tại Tràng An, thước phim tuyệt vời với hệ thống hang động, sông rừng tạo nên bức tranh hùng vĩ và huyền bí.',50),

    ('Miền Bắc', 1, 'Hà Nội - Hạ Long ','150.png', 2599000, 'Hàng Ngày', '4 ngày 3 đêm ', 'Hà Nội - Hạ Long - Ninh Bình - Hòn Trống ', 'Hành trình du lịch bắt đầu tại Hà Nội, thủ đô lịch sử đầy năng động, với các điểm tham quan như Hoàn Kiếm và Quảng Bá. Tiếp theo, chúng ta sẽ khám phá vịnh Hạ Long, một kỳ quan thiên nhiên hùng vĩ với những hòn đảo đá ngọc bí ẩn. Từ đó, hành trình dẫn đến Ninh Bình, "vịnh Hạ Long trên cạn," nổi tiếng với những thảo nguyên xanh, dòng sông êm đềm và đỉnh núi kỳ vĩ. Cuối cùng, chúng ta đến Hòn Trống, nơi biển xanh, cát trắng và bãi ngọc tạo nên bức tranh tuyệt vời cho kỳ nghỉ đáng nhớ.',50),

    ('Miền Bắc', 1, 'Tp Hồ Chí Minh - Yên Bái','151.png', 9999000, 'Hàng Ngày ', '3 ngày 2 đêm ', 'Thành phố Hồ Chí Minh - Mù Cang Chải - Yên Bái ', 'Tour du lịch này sẽ đưa bạn đến những điểm đẹp tuyệt vời, bắt đầu từ sự hối hả của Thành phố Hồ Chí Minh, nơi hiện đại và truyền thống giao thoa. Tiếp theo, Mù Cang Chải - vùng đất nổi tiếng với những thửa ruộng bậc thang hùng vĩ. Hành trình kết thúc tại Yên Bái, nơi thiên nhiên hòa quyện, từ cánh đồng lúa xanh mướt đến những dãy núi đầy huyền bí. Mỗi địa điểm mang đến cho bạn những trải nghiệm độc đáo, làm bừng sáng hành trình khám phá Việt Nam.',50),
    ...
    ('Miền Bắc', 1, 'Hà Nội - Mộc Châu - Điện Biên ','153.png', 8299000, 'Hàng Ngày ', '3 ngày 2 đêm ', 'Hà Nội - Mộc Châu - Điện Biên ', 'Tour du lịch từ Hà Nội đến Mộc Châu và Điện Biên là một hành trình tuyệt vời, đưa du khách đắm chìm trong vẻ đẹp tự nhiên hùng vĩ và văn hóa độc đáo. Tại Mộc Châu, những cánh đồng hoa dã quỳ bát ngát sắc màu tạo nên bức tranh thiên nhiên huyền bí. Chuyến đi tiếp theo đến Điện Biên, nơi lưu giữ những kí ức lịch sử đầy cảm xúc về cuộc chiến tranh. Du khách sẽ được thưởng thức không khí yên bình, hòa mình vào văn hóa bản địa và khám phá những địa điểm độc đáo trải dài trên hành trình này.',50),

    ('Miền Bắc', 1, 'Hà Nội - Tràng An ','154.png', 4999000, 'Hàng Ngày ', '4 ngày 3 đêm ', 'Hà Nội - Tràng An - Sapa - Bản Cát Cát ', 'Hành trình du lịch này mang đến cho bạn trải nghiệm tuyệt vời qua những điểm đẹp độc đáo tại Việt Nam. Bắt đầu từ thủ đô lịch sử Hà Nội, bạn sẽ khám phá văn hóa độc đáo tại Tràng An, một di sản thế giới nổi tiếng. Tiếp theo là hành trình đến Sapa, nơi có những thửa ruộng bậc thang hùng vĩ. Cuối cùng, Bản Cát Cát sẽ là điểm dừng cuối cùng, nơi bạn có cơ hội tìm hiểu về đời sống và văn hóa của người dân tộc thiểu số tại vùng núi phía Bắc.',50),

    ('Miền Bắc', 1, 'Hà Nội - Sapa ','155.png', 4699000, 'Hàng Ngày ', '4 ngày 3 đêm ', 'Hà Nội - Hạ Long - Ninh Bình - Sapa ', 'Hành trình du lịch này đưa du khách qua những địa danh tuyệt vời của miền Bắc Việt Nam. Từ thủ đô Hà Nội, bạn sẽ bắt đầu hành trình khám phá văn hóa và lịch sử độc đáo. Hạ Long huyền bí với những danh thắng thiên nhiên kỳ vĩ sẽ là điểm dừng tiếp theo. Ninh Bình, với vẻ đẹp của các thảo nguyên xanh mướt và cảnh quan hùng vĩ, là nơi để trải nghiệm sự bình yên. Cuối cùng, Sapa, với những rẻo núi hùng vĩ và văn hóa dân tộc độc đáo, sẽ kết thúc chuyến phiêu lưu này, mang lại những trải nghiệm không thể quên.',50),

    ('Miền Bắc', 1, 'Hà Nội - Ngọc Chiến ','156.png', 5999000, 'Hàng Ngày ', '3 ngày 2 đêm ', 'Hà Nội - Mù Cang Chải - Ngọc Chiến ', 'Hành trình du lịch từ Hà Nội đến Mù Cang Chải và Ngọc Chiến là một chuyến phiêu lưu tuyệt vời giữa vùng núi phong phú và hùng vĩ của Việt Nam. Từ thủ đô sôi động, du khách sẽ bắt đầu hành trình đi qua những cung đường ngoằn ngoèo đưa họ đến với bản đẹp như tranh ở Mù Cang Chải, nơi những thửa ruộng bậc thang mênh mông màu xanh non mắt tạo nên bức tranh tuyệt vời của sự hài hòa giữa con người và thiên nhiên. Khám phá Ngọc Chiến, vùng đất nơi văn hóa dân dụ truyền thống và vẻ đẹp tự nhiên hòa quyện, là trải nghiệm không thể quên trong chuyến hành trình này.',50),
    ('Miền Bắc', 1, 'Hà Nội - Ngọc Chiến ','157.png', 2499000, '1/9/2023 ', '3 ngày 2 đêm ', 'Hà Nội - Mù cang Chải - Ngọc Chiến ', 'Hành trình du lịch này đưa du khách từ trung tâm sôi động của Hà Nội đến vùng núi hùng vĩ Mù Cang Chải, nổi tiếng với những thước đồng ruộng bậc thang hình thành bởi bàn tay khéo léo của người dân tộc thiểu số. Trải qua cung đường quanh co, du khách sẽ bắt gặp những cảnh đẹp thiên nhiên tuyệt vời, từ những thửa ruộng lúa mênh mông đến những ngôi làng truyền thống. Tới Ngọc Chiến, điểm kết thúc, du khách sẽ bị cuốn hút bởi không khí trong lành, văn hóa dân dụ bản địa và cảm giác yên bình trước vẻ đẹp hoang sơ của miền núi.',50),
    ('Miền Bắc', 1, 'Hà Nội - Check in Moana ','158.png', 2299000, 'Hàng Ngày ', '4 ngày 3 đêm ', 'Hà Nội - Sapa - Bản Cát Cát - Check in Moana ', 'Tour du lịch "Hà Nội - Sapa - Bản Cát Cát - Check-in Moana" là hành trình tuyệt vời, đưa du khách đến những địa điểm tinh tế và hấp dẫn. Bắt đầu từ thủ đô lịch sử Hà Nội, du khách sẽ khám phá vẻ đẹp cổ kính và năng động. Tiếp theo, hành trình dẫn đến thị trấn Sapa, nơi tương tác với văn hóa độc đáo và thưởng ngoạn khung cảnh núi non hùng vĩ. Khám phá Bản Cát Cát mang đến trải nghiệm văn hóa dân dụ độc đáo. Kết thúc hành trình tại Check-in Moana, nơi du khách được đắm chìm trong không khí biển xanh mát, tận hưởng những khoảnh khắc trọn vẹn của kỳ nghỉ thư giãn và lưu giữ những kí ức đáng nhớ.',50),
    ('Miền Bắc', 1, 'Hà Nôi - Chùa Bái Đính ','159.png', 2199000, 'Hàng Ngày ', '4 ngày 3 đêm ', 'Hà Nôi - Sapa - Fansipan - Chùa Bái Đính ', 'Hành trình đặc sắc này dẫn dắt du khách từ trung tâm văn hóa lịch sử Hà Nội, nơi nổi tiếng với vẻ đẹp cổ kính và ẩm thực phong phú. Sau đó, hành trình tiếp tục đến Sapa, vùng đất hiên ngang với những thửa ruộng bậc thang huyền bí. Tại đỉnh Fansipan, "Nóc nhà Đông Dương", du khách sẽ được chiêm ngưỡng toàn cảnh hùng vĩ. Cuối cùng, Chùa Bái Đính, ngôi chùa lớn nhất Đông Nam Á, là điểm kết thúc hành trình với không khí thiêng liêng và tâm linh.',50),
    ('Miền Bắc', 1, 'Hà Nội - Sapa ','160.png', 2399000, 'Hàng Ngày ', '3 ngày 2 đêm ', 'Du lịch Hà Nội - Sapa - Hàm Rồng dịp Lễ ', 'Tour du lịch Hà Nội - Sapa - Hàm Rồng dịp Lễ là một hành trình tuyệt vời mang đến trải nghiệm đa dạng văn hóa và thiên nhiên. Bắt đầu từ thủ đô lịch sự Hà Nội, du khách sẽ đắm chìm trong không khí tươi mới tại Sapa, với những cánh đồng lúa bậc thang và những ngôi làng dân dụ bản địa. Chuyến thăm Hàm Rồng, nơi hòa mình vào huyền bí, kết thúc chuyến đi với những kỷ niệm đáng nhớ và hứng khởi.',50),
    ('Miền Bắc', 1, 'Mộc Châu - Hoa Mận ','161.png', 3399000, 'Hàng Ngày ', '2 ngày 1 đêm ', 'Mộc Châu Mùa Hoa Mơ - Hoa Mận ', 'Tour du lịch Mộc Châu Mùa Hoa Mơ mang đến cho du khách trải nghiệm tuyệt vời giữa bức tranh thiên nhiên tươi đẹp và huyền bí. Khi bước chân đặt xuống, bạn sẽ bị cuốn hút bởi những thảm hoa mận trắng muốt, tinh khôi, tạo nên không gian huyền bí giữa những thảm cỏ xanh ngắt. Không chỉ có vẻ đẹp tuyệt vời, tour còn mang đến cơ hội để du khách tận hưởng không khí trong lành, thưởng thức ẩm thực độc đáo và trải nghiệm văn hóa độc đáo của vùng cao nguyên tây bắc Việt Nam.',50),
    ('Miền Bắc', 1, 'Hà Nội - Mộc Châu - Mai Châu ','162.png', 4699000, 'Hàng Ngày ', '4 ngày 3 đêm ', 'Hà Nội - Mộc Châu - Mai Châu ', 'Tour du lịch Hà Nội - Mộc Châu - Mai Châu trong dịp Lễ là hành trình hứa hẹn mang đến trải nghiệm độc đáo với những cảnh đẹp thiên nhiên tuyệt vời. Tại Hà Nội, du khách sẽ đắm chìm trong không khí trầm mặc của lịch sử và văn hóa. Mộc Châu với những thảm cỏ xanh mướt, hoa cải trắng bồng bềnh, tạo nên bức tranh hữu tình. Mai Châu, với những ngôi nhà gỗ truyền thống và đồng ruộng lúa bát ngát, gửi gắm hồn quê Việt sâu đậm. Mỗi dấu tích đều kể một câu chuyện, hòa mình vào thiên nhiên hùng vĩ, tour này là hành trình khám phá sự đẹp tinh khôi và tận hưởng bản sắc văn hóa của miền Bắc Việt Nam.',50),
    ('Miền Bắc', 1, 'Hà Nội - Mộc Châu ','163.png', 1899000, '31/12/2023 ', '3 ngày 2 đêm ', 'Hà Nội - Mộc Châu - Cầu Kính Bạch Long ', 'Tour du lịch Hà Nội - Mộc Châu - Cầu Kính Bạch Long trong dịp Lễ là hành trình hòa mình vào vẻ đẹp hùng vĩ của núi rừng và thác nước tại Mộc Châu. Du khách sẽ được trải nghiệm không khí trong lành, hòa mình vào những thảm cỏ xanh mướt và ngắm nhìn những cánh đồng hoa mơ mộng. Điểm đặc biệt là chuyến thăm Cầu Kính Bạch Long, nơi mang đến góc nhìn tuyệt vời, mở ra bức tranh thiên nhiên tuyệt diệu, tạo nên những kỷ niệm đáng nhớ cho du khách.',50),
    ('Miền Bắc', 1, 'Hà Nội - Cát Cát - Hàm Rồng ','164.png', 8799000, 'Hàng Ngày ', '5 ngày 4 đêm ', 'Hà Nội - Cát Cát - Hàm Rồng ', 'Hành trình du lịch kỳ nghỉ ngắn tại miền Bắc Việt Nam mang đến cho bạn trải nghiệm không ngừng kỳ quan thiên nhiên và văn hóa. Tour bắt đầu từ thủ đô trăm năm tuổi, Hà Nội, nơi bạn sẽ hòa mình trong không khí trầm lắng của phố cổ. Tiếp theo, hành trình đưa bạn đến với những cung đường đáng kỳ vị như Cát Cát, Hàm Rồng, và đỉnh Fansipan - nói lên vẻ đẹp huyền bí của vùng núi Sapa. Mỗi dấu tích, mỗi cảm xúc, đều tạo nên chuyến đi đáng nhớ, kết thúc bằng sự trở về Hà Nội, nơi tâm hồn của bạn được thăng hoa trong bản nhạc văn hóa tinh tế.',50),
    ('Miền Bắc', 1, 'Sapa - Fansipan ','165.png', 8299000, 'Hàng Ngày ', '4 ngày 3 đêm ', 'Sapa - Bản Cát Cát - Hàm Rồng - Fansipan ', 'Hành trình du lịch từ Sapa đến Fansipan là một chuyến phiêu lưu tuyệt vời giữa vùng núi đầy nét đẹp hoang sơ của Bắc Việt Nam. Du khách sẽ bắt đầu từ thị trấn Sapa, nơi hòa mình vào văn hóa dân tộc độc đáo. Tiếp theo, họ sẽ đến Bản Cát Cát, nơi lưu giữ nền văn hóa truyền thống của người HMông. Hành trình tiếp tục đến Hàm Rồng, một điểm đến kỳ bí với các hòn đá khổng lồ. Cuối cùng, đỉnh Fansipan, nơi du khách có cơ hội chinh phục đỉnh cao nhất Đông Dương, hòa mình vào hùng vĩ thiên nhiên và tận hưởng không khí tinh khôi của núi rừng.',50),
    ('Miền Bắc', 1, 'Hà Nội - Sapa - Bản Cát Cát ','166.png', 1399000, 'Hàng Ngày ', '4 ngày 3 đêm ', 'Tour Lễ Hà Nội - Sapa - Bản Cát Cát ', 'Tour Lễ Hà Nội - Sapa - Bản Cát Cát là hành trình đắm chìm trong vẻ đẹp hùng vĩ của núi rừng Tây Bắc Việt Nam. Khám phá thủ đô lịch sử Hà Nội, với kiến trúc cổ kính và đời sống văn hóa độc đáo. Tiếp đó, du khách sẽ bước vào thế giới thơ mộng của Sapa, nơi những rừng thông xanh mướt hòa quyện với những thửa ruộng bậc thang tuyệt vời. Tour còn mang đến cơ hội khám phá Bản Cát Cát, với làng dân dụ bản địa, nơi lưu giữ và truyền thống nền văn hóa sặc sỡ.',50),
    ('Miền Bắc', 1, 'Hà Nội - Sin Suối Hồ  ','167.png', 3899000, '10/2/2024 ', '4 ngày 3 đêm ', 'Hà Nội - Sapa - Lai Châu - Sin Suối Hồ ', 'Hành trình du lịch từ Hà Nội đến Sapa, tiếp theo là Lai Châu và kết thúc tại Sin Suối Hồ là một cuộc phiêu lưu tuyệt vời giữa vẻ đẹp hùng vĩ của núi rừng và vùng cao Bắc Bộ. Du khách sẽ bắt đầu từ thủ đô tráng lệ, trải nghiệm không khí trong lành của núi Sapa, khám phá văn hóa dân tộc thiểu số, và rồi lạc vào vùng đồng bằng sâu thẳm của Lai Châu. Cuộc hành trình kết thúc bằng sự huyền bí tại Sin Suối Hồ, nơi hòa mình vào khung cảnh hòn ngọc tự nhiên giữa núi rừng hùng vĩ.',50),
    ('Miền Bắc', 1, 'Hà Nội - Fansipan ','168.png', 4399000, 'Hàng Ngày ', '4 ngày 3 đêm ', 'Hà Nội - Sapa - Fansipan ', 'Tour du lịch Hà Nội - Sapa - Fansipan - Hàm Rồng là hành trình tuyệt vời đưa du khách khám phá vẻ đẹp đa dạng của miền Bắc Việt Nam. Khởi hành từ thủ đô Hà Nội, hành trình mang đến trải nghiệm tại thị trấn Sapa, nơi hòa mình vào khung cảnh nên thơ của những thửa ruộng bậc thang và dãy núi hùng vĩ. Đỉnh Fansipan, mái trời Việt Nam, là điểm đến đắm chìm trong sự hùng vĩ của dãy núi Hoàng Liên. Cuối cùng, Hàm Rồng với vườn hoa rực rỡ tạo nên kết thúc hoàn hảo cho hành trình đầy ấn tượng này',50),
    ('Miền Bắc', 1, 'Sapa - Fanxipang ','169.png', 2899000, 'Hàng Ngày ', '4 ngày 3 đêm ', 'Sapa - Cát Bát - Hàm Rồng - Fanxipang ', 'Tour du lịch đưa bạn đến những vùng đất tuyệt vời và hùng vĩ của miền Bắc Việt Nam. Từ vẻ đẹp huyền bí của Sapa, nơi có những thửa ruộng bậc thang trải dài đến Cát Bà, hòn đảo xinh đẹp nằm giữa vịnh Lan Hạ. Tiếp theo, bạn sẽ khám phá Hàm Rồng, khu du lịch tự nhiên với những cảnh đẹp độc đáo. Cuối cùng, hành trình kết thúc tại đỉnh Fanxipang, điểm cao nhất Đông Nam Á, nơi mang đến trải nghiệm hấp dẫn và những kỷ niệm khó quên.',50),
    ('Miền Bắc', 1, 'Sapa - Fanxipan','170.png', 4299000, 'Hàng Ngày ', '4 ngày 3 đêm ', 'Sapa - Cát Cát - Hàm Rồng - Fanxipan ', 'Hành trình du lịch khám phá vùng núi Tây Bắc tại Sapa sẽ đưa du khách đến những địa điểm tuyệt vời như thác Cát Cát hùng vĩ, làng Hàm Rồng truyền thống của dân tộc HMông, và đỉnh núi Fanxipan - "Rồng của Đông Dương". Trải nghiệm độc đáo này mang đến không khí trong lành, khám phá văn hóa độc đáo và cảm nhận vẻ đẹp huyền bí của núi rừng nơi đỉnh cao nhất Việt Nam.',50),
    ('Miền Bắc', 1, 'Tây Bắc - Cầu Kính Bạch Long ','171.png', 6599000, 'Hàng Ngày ', '4 ngày 3 đêm ', 'Tây Bắc - Hà Nội - Mộc Châu - Cầu Kính Bạch Long ', 'Hành trình du lịch Tây Bắc - Hà Nội - Mộc Châu - Cầu Kính Bạch Long là một chuyến phiêu lưu độc đáo, nơi bạn sẽ khám phá vẻ đẹp thiên nhiên hùng vĩ và đa dạng văn hóa của miền Bắc Việt Nam. Từ thành phố năng động Hà Nội, hành trình dẫn bạn đến vùng núi Tây Bắc, nơi có những cảnh đẹp huyền bí của đỉnh núi, thác nước và đồng cỏ xanh mát tại Mộc Châu. Cuối cùng, thưởng thức sự yên bình tại Cầu Kính Bạch Long, một điểm đến lý tưởng cho những ai muốn tận hưởng không khí trong lành và cảm nhận hòa mình vào bản hòa nhạc thiên nhiên tuyệt vời.',50),
    ('Miền Bắc', 1, 'Hà Nội - Phú Thọ - Đền Hùng ','172.png', 8199000, 'Hàng Ngày ', '3 ngày 2 đêm ', 'Hà Nội - Đền Hùng - Phú Thọ', 'Tour du lịch Hà Nội - Đền Hùng - Phú Thọ là hành trình huyền bí đưa du khách khám phá vùng đất lịch sử và văn hóa tại miền Bắc Việt Nam. Tại Hà Nội, du khách sẽ đắm chìm trong không khí trầm lắng của Hoàn Kiếm, thăm Quảng trường Ba Đình và thưởng thức ẩm thực đặc sắc. Hành trình tiếp tục đến Đền Hùng, nơi tưởng nhớ tổ tiên và học hỏi về lịch sử dòng họ Việt Nam. Cuối cùng, tại Phú Thọ, du khách sẽ khám phá những di tích lịch sử và thưởng thức vẻ đẹp êm đềm của quê hương.',50),
    ('Miền Bắc', 1, 'Vĩnh Phúc - Tam Đảo - Tây Thiên ','173.png', 9999000, 'Hàng Ngày ', '3 ngày 2 đêm ', 'Vĩnh Phúc - Tam Đảo - Tây Thiên ', 'Tour du lịch Vĩnh Phúc - Tam Đảo - Tây Thiên là hành trình tuyệt vời khám phá vùng Bắc Trung Bộ Việt Nam. Tại Vĩnh Phúc, du khách sẽ đắm chìm trong vẻ đẹp hòa mình vào cuộc sống đồng quê, trải nghiệm văn hóa và thưởng thức ẩm thực độc đáo. Tam Đảo, với khí hậu mát mẻ quanh năm, là điểm đến lý tưởng cho những chuyến trekking và khám phá thiên nhiên hùng vĩ. Cuối cùng, Tây Thiên mang đến không khí linh thiêng với các đền chùa tuyệt vời, là nơi hòa mình vào tâm linh và tận hưởng bình yên.',50),
    ('Miền Bắc', 1, 'Hà Nội - Bắc Ninh - Hạ Long ','174.png', 6499000, 'Hàng Ngày ', '4 ngày 3 đêm ', 'Hà Nội - Bắc Ninh - Đền Đô - Hạ Long ', 'Tour du lịch này sẽ đưa du khách đến những điểm đẹp độc đáo của miền Bắc Việt Nam. Hành trình bắt đầu tại Hà Nội, thủ đô nghìn năm văn hiến với những di tích lịch sử và kiến trúc độc đáo. Tiếp theo là Bắc Ninh, nơi lưu giữ nét truyền thống văn hóa và nghệ thuật dân gian. Đến Đền Đô, du khách sẽ khám phá văn hóa tâm linh tại các đền đài lịch sử. Hành trình kết thúc tại Hạ Long, một trong những di sản thiên nhiên kỳ diệu của thế giới với vịnh biển hùng vĩ và hang động kỳ quái.',50),
    ('Miền Bắc', 1, 'Hà Nội - Yên Tử - Hạ Long ','175.png', 8599000, 'Hàng Ngày ', '4 ngày 3 đêm ', 'Hà Nội - Yên Tử - Hạ Long - Đền Đô ', 'Hành trình du lịch đặc sắc từ Hà Nội đến Yên Tử, Hạ Long và Đền Đô là một cuộc phiêu lưu độc đáo, hòa mình vào vẻ đẹp lịch sử và thiên nhiên hùng vĩ. Từ thủ đô lịch sử Hà Nội, bạn sẽ bắt đầu hành trình tôn vinh tại Yên Tử, nơi linh thiêng và tâm linh hòa quyện. Tiếp theo, hòa mình trong hạnh phúc của Vịnh Hạ Long, thảo nguyên đá karst hùng vĩ. Cuối cùng, trở về Đền Đô để khám phá vẻ đẹp kiến trúc và lịch sử độc đáo. Đây chắc chắn là một hành trình đầy ấn tượng và trải nghiệm độc đáo.',50),
    ('Miền Bắc', 1, 'Ninh Bình - Chùa Bái Đính - Tràng An ','176.png', 4299000, 'Hàng Ngày ', '3 ngày 2 đêm ', 'Ninh Bình - Chùa Bái Đính - Tràng An ', 'Tour du lịch Ninh Bình - Chùa Bái Đính - Tràng An là một hành trình đầy ấn tượng, mang đến trải nghiệm hòa mình vào vẻ đẹp tự nhiên tuyệt vời và tâm linh. Bắt đầu từ Ninh Bình, du khách sẽ khám phá vùng đất tươi đẹp với những cánh đồng lúa xanh bát ngát. Chùa Bái Đính, nằm giữa khung cảnh núi non hùng vĩ, là điểm đến tôn giáo và văn hóa quan trọng. Kết thúc hành trình là Tràng An, hệ thống hang động và hồ nước lạ mắt, nơi du khách có cơ hội thư giãn và tận hưởng sự hòa mình giữa thiên nhiên hùng vĩ.',50),
    ...
    ('Miền Bắc', 1, 'Hà Nội - Tuyệt Tình Cốc ','178.png', 4999000, 'Hàng Ngày ', '4 ngày 3 đêm ', 'Hà Nội - Chùa Tam Chúc - Ninh Bình - Tuyệt Tình Cốc ', 'Tour du lịch đưa bạn đến những điểm đẹp tuyệt vời của miền Bắc Việt Nam. Hành trình bắt đầu tại Hà Nội, nơi lưu giữ vẻ đẹp lịch sử và văn hóa. Tiếp theo, bạn sẽ ghé thăm Chùa Tam Chúc, ngôi chùa lớn nhất Đông Nam Á, nằm giữa hồ nước xanh biếc. Sau đó, hành trình hướng về Ninh Bình, với cảnh đẹp ngoạn ngục của các vách đá và đèo non. Tour kết thúc tại Tuyệt Tình Cốc, một điểm đón chào bình minh huyền bí, tạo nên kỷ niệm đáng nhớ trong lòng du khách.',50),
    ('Miền Bắc', 1, 'Hà Nội - Sapa ','179.png', 5199000, 'Hàng Ngày ', '5 ngày 4 đêm ', 'Hà Nội - Hoa Lư - Sapa - Đền Hùng ', 'Hành trình du lịch đắm chìm trong vẻ đẹp lịch sử và thiên nhiên tuyệt vời, tour từ Hà Nội - Hoa Lư - Sapa - Đền Hùng Cốc là một chuyến phiêu lưu đầy ấn tượng. Bắt đầu từ thủ đô năng động Hà Nội, bạn sẽ khám phá di tích lịch sử Hoa Lư, ngắm nhìn vùng núi hùng vĩ tại Sapa, và trải nghiệm sự linh thiêng tại Đền Hùng Cốc. Đây là cuộc hành trình kỳ diệu đưa du khách đến với vẻ đẹp đa dạng của Việt Nam, từ thành phố sôi động đến cảnh đẹp tự nhiên hùng vĩ.',50),
    ('Miền Bắc', 1, 'Hà Nội - Hoa Lư ','180.png', 9599000, 'Hàng Ngày ', '4 ngày 3 đêm ', 'Hà Nội - Bái Đính - Tràng An - Hoa Lư ', 'Hành trình du lịch này đưa du khách đến những điểm đẹp nổi tiếng và lịch sử tại Việt Nam. Bắt đầu từ thủ đô lịch sử Hà Nội, bạn sẽ ngắm nhìn vẻ đẹp tinh tế của Bái Đính, điểm hành hương lớn nhất Đông Nam Á. Tiếp theo, Tràng An hiền hòa và quyến rũ bởi hệ thống hang động và cảnh đồng quê hữu tình. Hành trình kết thúc tại Hoa Lư Cốc, nơi hòa mình trong không gian lịch sử cổ kính và tận hưởng tĩnh lặng của quê hương.',50),
    ('Miền Bắc', 1, 'Hoa Lư - Hang Múa ','181.png', 6999000, 'Hàng Ngày ', '2 ngày 1 đêm ', 'Hà Nội - Hang Múa ', 'Tour du lịch Hà Nội - Hang Múa là một hành trình đầy hứng khởi, mang đến trải nghiệm tuyệt vời giữa văn hóa đậm đà của thủ đô Hà Nội và vẻ đẹp hùng vĩ của Hang Múa. Du khách sẽ khám phá những di tích lịch sử lâu dài, thưởng thức ẩm thực phong phú và thư giãn trong không khí yên bình. Đặc biệt, đến Hang Múa, du khách sẽ được hòa mình vào không gian thiên nhiên tuyệt vời, với cảnh đèn hoàng hôn tô điểm cho một trải nghiệm khó quên.',50),
    ('Miền Bắc', 1, 'Hà Nội - Chùa Hương ','182.png', 1599000, 'Hàng Ngày ', '2 ngày 1 đêm ', 'Bắc Hà Nội - Chùa Hương ', 'Tour du lịch "Bắc Hà Nội - Chùa Hương" là hành trình tuyệt vời đưa du khách qua những vùng đất hùng vĩ và linh thiêng. Tại Bắc Hà Nội, bạn sẽ bắt gặp vẻ đẹp hoang sơ của núi rừng và hòa mình vào văn hóa độc đáo của các dân tộc thiểu số. Đến Chùa Hương, một điểm hành hương tâm linh nằm giữa cảnh đẹp hữu tình, du khách sẽ trải qua không gian thanh tịnh và cảm nhận sức sống tâm linh từ những nét kiến trúc độc đáo và lịch sử lâu dài.',50),
    ('Miền Bắc', 1, 'Hà Nội - Yên Tử','183.png', 5299000, 'Hàng Ngày ', '2 ngày 1 đêm ', 'Hà Nội - Yên Tử ', 'Tour du lịch Hà Nội - Yên Tử là hành trình huyền bí đưa du khách từ trung tâm lịch sử và văn hóa Hà Nội đến ngôi chùa linh thiêng Yên Tử, nằm trên đỉnh núi Yên Tử hùng vĩ. Đây không chỉ là kỳ nghỉ thư giãn giữa không gian thiên nhiên tươi đẹp mà còn là cơ hội để du khách khám phá những di tích lịch sử, nền văn hóa độc đáo và tận hưởng không khí tĩnh lặng của miền núi Bắc Bộ.',50),
    ('Miền Bắc', 1, 'Hà Nội - Ba Vì','184.png', 6599000, 'Hàng Ngày ', '1 ngày 0 đêm ', 'Hà Nội - Ba Vì', 'Tour du lịch "Hà Nội - Ba Vì" mang đến trải nghiệm độc đáo giữa bức tranh thiên nhiên tươi đẹp và văn hóa đậm đà. Khởi hành từ trái tim thủ đô Hà Nội, chúng ta sẽ bắt đầu hành trình khám phá Ba Vì, nơi núi non hùng vĩ và rừng xanh mát hòa quyện. Dạo bước trong không gian yên bình, du khách sẽ được thư giãn, thưởng thức ẩm thực độc đáo và trải nghiệm những hoạt động ngoại ô thú vị, tạo nên kỷ niệm đáng nhớ trong hành trình khám phá miền Bắc Việt Nam.',50),
    ('Miền Bắc', 1, 'Tam Chúc - Chùa Bà Đanh ','185.png', 2399000, 'Hàng Ngày ', '2 ngày 1 đêm ', 'Chùa Tam Chúc - Chùa Bà Đanh ', 'Chuyến du lịch đến Chùa Tam Chúc và Chùa Bà Đanh mang đến trải nghiệm tâm linh và hòa mình vào vẻ đẹp tâm hồn của Việt Nam. Tại Chùa Tam Chúc, du khách sẽ bị cuốn hút bởi hình ảnh hòa mình giữa hồ nước lớn và những ngôi chùa linh thiêng. Chùa Bà Đanh, với kiến trúc cổ kính, tạo nên không khí yên bình và trang nghiêm. Cả hai địa điểm đều là nơi lý tưởng để tìm kiếm bình an và tận hưởng vẻ đẹp văn hóa truyền thống.',50),
    ('Miền Bắc', 1, 'Hà Nội - City Hà Nội - Hồ Gươm ','186.png', 1999000, 'Hàng Ngày ', '3 ngày 2 đêm ', 'Bắc Hà Nội - City Hà Nội - Hồ Gươm ', 'Tour du lịch Hà Nội - City Hà Nội - Hồ Gươm là hành trình tuyệt vời đưa du khách khám phá vẻ đẹp lịch sử và văn hóa của thủ đô Việt Nam. Trải qua những con đường cổ kính của Hà Nội, du khách sẽ bắt gặp những di tích lịch sử nổi tiếng và thưởng thức những món ăn ngon đặc trưng. Đặc biệt, chuyến tham quan Hồ Gươm sẽ mang lại trải nghiệm tuyệt vời với không khí yên bình và hòa mình vào vẻ đẹp thơ mộng của hồ thành phố.',50),
    ('Miền Bắc', 1, 'Thanh Hóa ','187.png', 1999000, 'Hàng Ngày ', '3 ngày 2 đêm ', 'Đền Sòng Sơn - Đền Cô Chín - Suối Cá ', 'Hành trình du lịch qua "Đền Sòng Sơn - Đền Cô Chín - Suối Cá" là một hành trình tuyệt vời khám phá vẻ đẹp tâm linh và thiên nhiên tại vùng miền. Bắt đầu từ sự trang nghiêm của Đền Sòng Sơn, nơi lưu giữ hồn quê hương, đưa du khách đến Đền Cô Chín, nơi linh thiêng với những câu chuyện lịch sử. Cuối cùng, Suối Cá mang lại trải nghiệm tận hưởng bản địa với cảnh đẹp thiên nhiên tươi mới và không khí trong lành, là điểm kết thúc hành trình đáng nhớ.',50),
    ('Miền Bắc', 1, 'Thanh Hóa ','188.png', 4399000, 'Hàng Ngày ', '3 ngày 2 đêm ', 'Thanh Hóa - Yên Tử - Tràng An ', 'Tour du lịch từ Thanh Hóa đến Yên Tử và Tràng An là một hành trình tuyệt vời, mang đến trải nghiệm đa dạng về văn hóa và thiên nhiên. Từ vẻ đẹp lịch sử của Thanh Hóa, du khách sẽ hòa mình vào không khí tâm linh tại Yên Tử, nơi có đỉnh Phật tự linh thiêng. Sau đó, họ sẽ đắm chìm trong vẻ đẹp hùng vĩ của Tràng An, với những hệ thống hang động và cảnh quan thiên nhiên kỳ diệu. Mỗi điểm dừng đều là một trải nghiệm độc đáo, hấp dẫn du khách bằng sự phong phú và tinh tế của văn hóa Việt Nam.',50),
    ('Miền Bắc', 1, 'Thanh Hóa - Vịnh Hạ Long - Yên Tử ','189.png', 1799000, 'Hàng Ngày ', '3 ngày 2 đêm ', 'Pù Luông - Vịnh Hạ Long - Yên Tử ', 'Tour du lịch kết hợp Pù Luông, Vịnh Hạ Long và Yên Tử là một hành trình tuyệt vời khám phá vẻ đẹp đa dạng của Việt Nam. Khởi hành từ thôn quê bình yên ở Pù Luông, du khách sẽ được trải nghiệm cuộc sống nông thôn truyền thống. Hành trình tiếp tục với Vịnh Hạ Long, với những danh thắng ngoạn mục, đảo đá hình thù độc đáo. Kết thúc chuyến đi ở Yên Tử, nơi tâm linh hòa mình giữa thiên nhiên hùng vĩ và không gian linh thiêng. Tour này là một hành trình đầy ấn tượng và trải nghiệm đa chiều.',50),
    ('Miền Bắc', 1, 'Hà Nội - Hòa Bình ','190.png', 6399000, 'Hàng Ngày ', '4 ngày 3 đêm ', 'Hà Nội - Thung Nai - Suối khoáng Kim Bồi - Hòa Bình ', 'Tour du lịch Hà Nội - Thung Nai - Suối khoáng Kim Bồi - Hòa Bình là hành trình tuyệt vời, đưa du khách khám phá vẻ đẹp hài hòa giữa nét cổ kính của Hà Nội, vùng quê thơ mộng Thung Nai, đến những nguồn nước khoáng tinh khiết tại Suối khoáng Kim Bồi. Du khách sẽ được trải nghiệm không khí trong lành, cảm nhận vị ngon của đặc sản địa phương và thư giãn trong khung cảnh tươi đẹp của Hòa Bình, tạo nên một chuyến đi đáng nhớ.',50),
    ('Miền Bắc', 1, 'Sapa ','191.png', 9299000, 'Hàng Ngày ', '3 ngày 2 đêm ', 'Sa Pa - Bản Cát Cát - Hàm Rồng ', 'Tour du lịch Sa Pa - Bản Cát Cát - Hàm Rồng là một hành trình tuyệt vời khám phá vẻ đẹp huyền bí của vùng núi phía Bắc Việt Nam. Hành trình bắt đầu tại Sa Pa, nơi bạn sẽ được ngắm nhìn những thửa ruộng bậc thang lộng lẫy. Tiếp theo, tour dẫn bạn đến Bản Cát Cát, nơi văn hóa của các dân tộc thiểu số rực rỡ. Cuối cùng, Hàm Rồng, với cảnh đẹp hùng vĩ và sự tĩnh lặng của thiên nhiên, đưa du khách vào một trải nghiệm du lịch đậm chất thơ mộng và truyền thống.',50),
    ('Miền Bắc', 1, 'Sapa ','192.png', 9899000, 'Hàng Ngày ', '2 ngày 1 đêm ', 'Tour Du lịch Sapa - Bản Cát Cát ', 'Tour du lịch Sapa - Bản Cát Cát là một hành trình tuyệt vời đưa du khách đến khám phá vùng núi phong cảnh hùng vĩ của Sapa, Việt Nam. Từ thị trấn Sapa, hành trình bắt đầu với những con đường mòn xanh ngắt, dẫn dắt khách qua thung lũng mộng mơ. Tại Bản Cát Cát, du khách sẽ trải nghiệm không khí bình dị của ngôi làng dân dụ HMông, ngắm nhìn những thửa ruộng bậc thang tuyệt vời và hiểu rõ văn hóa độc đáo của cộng đồng dân tộc thiểu số.',50),
    ('Miền Bắc', 1, 'Sapa ','193.png', 5799000, 'Hàng Ngày ', '2 ngày 1 đêm ', 'Sapa - Chinh Phục Đỉnh Fansipan ', 'Tour du lịch "Sapa - Chinh Phục Đỉnh Fansipan" là chuyến hành trình kỳ thú đưa du khách đến với vùng núi hùng vĩ của Sapa, Việt Nam. Hành trình không chỉ khám phá văn hóa dân dụ độc đáo và thưởng thức ẩm thực tinh tế mà còn đưa du khách đến thách thức tuyệt vời nhất - leo lên Đỉnh Fansipan, đỉnh núi cao nhất Đông Nam Á. Trải nghiệm không chỉ là hành trình vượt đèo, mà còn là cuộc phiêu lưu tới những đỉnh cao, ngắm cảnh thiên nhiên tuyệt vời và gặp gỡ những bản làng truyền thống.',50),
    ('Miền Bắc', 1, 'Hà Nội - Sapa','194.png', 2799000, 'Hàng Ngày ', '3 ngày 2 đêm ', 'Hà Nội - Hàm Rồng - Chinh Phục Đỉnh Fansipan ', 'Tour du lịch "Hà Nội - Hàm Rồng - Chinh Phục Đỉnh Fansipan" là hành trình kỳ thú khám phá vùng Bắc Việt Nam. Đặt chân đến thủ đô lịch sử Hà Nội, du khách sẽ trải nghiệm không khí hồn hương của thành phố cổ, khám phá Hàm Rồng - khu vườn thiên nhiên tuyệt vời với cảnh đẹp hùng vĩ. Hành trình đưa du khách đến thách thức bản thân khi chinh phục đỉnh Fansipan - đỉnh núi cao nhất Đông Nam Á. Một hành trình không chỉ là khám phá vẻ đẹp tự nhiên mà còn là thử thách tinh thần và trải nghiệm văn hóa độc đáo của dân tộc vùng núi.',50),
    ('Miền Bắc', 1, 'Lào Cai - Sapa ','195.png', 4199000, 'Hàng Ngày ', '3 ngày 2 đêm ', 'Lào Cai - Hà Khẩu - Sapa ', 'Hành trình du lịch từ Lào Cai đến Hà Khẩu và Sapa là một chuyến phiêu lưu hấp dẫn, đưa du khách khám phá vùng núi Tây Bắc Việt Nam nổi tiếng với địa hình hùng vĩ và văn hóa dân dụ độc đáo. Từ thành phố biên giới Lào Cai, du khách sẽ trải nghiệm hương vị văn hóa dân dụ đặc trưng, tiếp theo là hành trình đến thị trấn Hà Khẩu, nơi kết nối với Sapa qua những con đường ngoằn nghèo, nhưng đồng thời ẩn chứa vẻ đẹp hoang sơ và tinh tế của miền núi Tây Bắc.',50),
    ('Miền Bắc', 1, 'Hà Giang ','196.png', 1699000, '25/12/2023 ', '3 ngày 2 đêm ', 'Hà Giang - Quản Bạ - Đồng Văn ', 'Tour du lịch Hà Giang - Quản Bạ - Đồng Văn là hành trình hấp dẫn đưa du khách đến với vùng núi đồng bằng karst hùng vĩ. Từ Hà Giang, chúng ta sẽ bắt đầu cuộc phiêu lưu đến Quản Bạ, nơi có đèo Mã Pí Lèng ngoạn mục và cánh đồng bậc thang tuyệt vời. Đến Đồng Văn, khám phá Vườn địa đạo Đồng Văn và thưởng ngoạn cảnh đá mặt trời, tạo nên chuyến đi không gì so sánh. Tour mang lại trải nghiệm văn hóa độc đáo và hòa mình vào vẻ đẹp huyền bí của cao nguyên đá Đồng Văn.',50),
    ('Miền Bắc', 1, 'Hà Nội - Sơn La ','197.png', 6599000, 'Hàng Ngày ', '4 ngày 3 đêm ', 'Hà Nội - Hà Giang - Quản Bạ - Sơn La ', 'Hành trình du lịch từ Hà Nội đến Sơn La sẽ đưa bạn qua những địa điểm tuyệt vời nhất của Bắc Việt Nam. Từ sự trấn an và lịch sự của Hà Nội, bạn sẽ khám phá vẻ đẹp hùng vĩ của núi non ở Hà Giang và thăm thú cảnh đẹp thiên nhiên tại Quản Bạ. Hành trình sẽ kết thúc tại Sơn La, nơi bạn có cơ hội tận hưởng không khí trong lành, thưởng thức ẩm thực độc đáo và hiểu rõ hơn về văn hóa động bộ của người dân địa phương.',50),
    ('Miền Bắc', 1, 'Mộc Châu - Hà Nội ','198.png', 4399000, '30/12/2023 ', '3 ngày 2 đêm ', 'Mộc Châu - Mai Châu - Hà Nội ', 'Tour du lịch từ Mộc Châu đến Mai Châu và cuối cùng là Hà Nội là một hành trình tuyệt vời, mang đến trải nghiệm đa dạng về văn hóa và thiên nhiên. Tại Mộc Châu, bạn sẽ bị cuốn hút bởi vùng núi rừng tươi tốt, đồng cỏ xanh mướt. Tiếp theo, Mai Châu mang đến không khí yên bình của làng quê, với những ngôi nhà gỗ truyền thống và văn hóa dân dụ độc đáo. Cuối cùng, Hà Nội với lịch sử lâu dài và văn hóa phồn thịnh sẽ là điểm kết thúc hoàn hảo cho hành trình khám phá này.',50),
    ('Miền Bắc', 1, 'Hà Giang - Cao Bằng','199.png', 6799000, 'Mùng 2 Tết ', '3 ngày 2 đêm ', 'Hà Giang - Đồng Văn - Cao Bằng ', 'Tour du lịch từ Hà Giang đến Đồng Văn và Cao Bằng là một hành trình kỳ diệu khám phá vùng đất núi phong phú và hùng vĩ của miền Bắc Việt Nam. Du khách sẽ được đắm chìm trong khung cảnh thiên nhiên tuyệt vời, từ những thửa ruộng bậc thang xanh mướt của Hà Giang đến vùng Đồng Văn đá ngầm nổi tiếng. Tour còn mang đến trải nghiệm văn hóa độc đáo khi khám phá các bản làng dân dụ tự nhiên và thưởng thức ẩm thực đặc sắc của vùng cao nguyên Cao Bằng.',50),
    ('Miền Bắc', 1, 'Hà Nội - Hà Giang ','200.png', 2799000, 'Hàng Ngày ', '3 ngày 2 đêm ', 'Hà Nội - Đồng Văn - Cột cờ Lũng Cú ', 'Tour du lịch Hà Nội - Đồng Văn - Cột cờ Lũng Cú là hành trình huyền bí đưa du khách khám phá vẻ đẹp lịch sử và thiên nhiên tại Bắc Việt Nam. Từ Hà Nội, hành trình đưa bạn đến Đồng Văn, nơi giữa vùng cao nguyên đá độc đáo. Đây không chỉ là cơ hội để tận hưởng khung cảnh ngoạn ngục của đỉnh núi, mà còn là cơ hội để hiểu rõ về văn hóa và đời sống dân tộc thiểu số. Khám phá Cột cờ Lũng Cú, biểu tượng lịch sử, là hành trình đậm chất khám phá, kết nối với bản sắc văn hóa độc đáo của vùng đất núi.',50),
    ('Miền Bắc', 1, 'Hạ Long - Sapa ','201.png', 5199000, 'Hàng Ngày ', '3 ngày 2 đêm ', 'Vịnh Hạ Long - Yên Tử - Sapa ', 'Tour du lịch hấp dẫn khám phá vùng Bắc Bộ Việt Nam bao gồm Vịnh Hạ Long, Yên Tử và Sapa. Khởi hành từ Hà Nội, bạn sẽ được đắm chìm trong vẻ đẹp huyền bí của Vịnh Hạ Long với những hòn đảo đá karst nổi tiếng. Tại Yên Tử, nơi có chùa dã ngoại thiêng liêng, bạn sẽ trải nghiệm không khí tâm linh và ngắm cảnh núi non hùng vĩ. Cuối cùng, Sapa đưa bạn đến với những thửa ruộng bậc thang đẹp như tranh, nơi gặp gỡ với văn hóa dân tộc sôi động.',50),
    ('Miền Bắc', 1, 'Yên Tử - Ba Vàng ','202.png', 1499000, 'Hàng Ngày ', '4 ngày 3 đêm ', 'Hà Nội - Yên Tử - Ba Vàng - Mai Châu ', 'Hành trình du lịch qua Hà Nội, Yên Tử, Ba Vàng và Mai Châu mang đến trải nghiệm độc đáo của văn hóa Việt Nam. Bắt đầu tại Hà Nội, khám phá đô thị lịch sử với các di tích và món ăn đặc sắc. Tiếp theo, Yên Tử và Ba Vàng là những địa điểm linh thiêng, với chân đèo dẫn lên chùa trên đỉnh núi và tượng Chúa Buddha lấp lánh giữa không gian thiên nhiên hùng vĩ. Cuối cùng, tại Mai Châu, bạn sẽ ngắm nhìn vẻ đẹp hòa quyện của thác nước, rừng xanh và làng trại trải dài trên thung lũng.',50),
    ('Miền Bắc', 1, 'Hà Nội - Hạ Long ','203.png', 6799000, 'Hàng Ngày ', '4 ngày 3 đêm ', 'Hà Nội - Hạ Long - Hang Múa - Bái Đính ', 'Tour du lịch từ Hà Nội đến Hạ Long, Hang Múa, và Bái Đính là một hành trình tuyệt vời khám phá vẻ đẹp đa dạng của miền Bắc Việt Nam. Bắt đầu từ Hà Nội, thủ đô lịch sử, bạn sẽ hồi hương qua các con phố cổ và thưởng thức ẩm thực độc đáo. Tiếp theo, Hạ Long hấp dẫn với vịnh nước kỳ vĩ và đảo quốc huyền bí. Tại Hang Múa, bạn sẽ ngỡ ngàng trước vẻ đẹp thiên nhiên và tận hưởng tầm nhìn toàn cảnh. Cuối cùng, thăm Bái Đính với kiến trúc độc đáo của chùa lớn và không khí tâm linh tuyệt vời.',50),
    ('Miền Bắc', 1, 'Hà Nội - Hạ Long ','204.png', 4499000, 'Hàng Ngày ', '3 ngày 2 đêm ', 'Hà Nội - Hạ Long - Đảo Bạch Long Vĩ ', 'Tour du lịch "Hà Nội - Hạ Long - Đảo Bạch Long Vĩ" là hành trình tuyệt vời, kết hợp giữa sự huyền bí của thủ đô nghìn năm tuổi Hà Nội, với những di tích lịch sử và văn hóa, và vẻ đẹp tuyệt vời của vịnh Hạ Long với hàng nghìn đảo đá kỳ quặc. Hành trình tiếp tục đưa du khách đến Đảo Bạch Long Vĩ, một thiên đường hoang sơ, nơi họ có cơ hội khám phá bãi biển dịu dàng, thưởng thức ẩm thực độc đáo và tận hưởng không gian yên bình giữa biển cả.',50),
    ('Miền Bắc', 1, 'Hà Nội - Thác Bản Giốc ','205.png', 3399000, '20/11/2023 ', '3 ngày 2 đêm ', 'Hà Nội - Hồ Ba Bể - Thác Bản Gốc ', 'Tour du lịch này mang đến cho du khách một hành trình tuyệt vời qua những điểm đẹp tinh khôi của miền Bắc Việt Nam. Bắt đầu từ Hà Nội, thủ đô lịch sử với văn hóa độc đáo, du khách sẽ hòa mình trong không khí trấn an của Hồ Ba Bể, nơi hồ nước xanh bát ngát giữa những ngọn núi hùng vĩ. Chặng cuối cùng dẫn đến Thác Bản Gốc, nơi cảm nhận sức mạnh hùng vĩ của thiên nhiên và đắm chìm trong khung cảnh huyền bí, tạo nên một trải nghiệm du lịch đậm chất khám phá.',50),
    ('Miền Bắc', 1, 'Hà Nội - chùa Tây Phương ','206.png', 3999000, 'Hàng Ngày ', '1 ngày 0 đêm ', 'Hà Nội – chùa Thầy – Chùa Tây Phương', 'Hành trình du lịch này đưa du khách khám phá những địa điểm tâm linh tại miền Bắc Việt Nam. Từ Hà Nội, thành phố với vẻ đẹp hài hòa giữa nét cổ kính và hiện đại, du khách sẽ bắt đầu hành trình đến Chùa Thầy - nơi linh thiêng, trùng Hiếu khí tựa như thiên đàng hình trần. Tiếp theo là Chùa Tây Phương, điểm đến với kiến trúc độc đáo và tượng Phật đồ sộ. Tour du lịch này hứa hẹn mang đến trải nghiệm tâm linh và khám phá văn hóa độc đáo của miền Bắc.',50),
    ('Miền Bắc', 1, 'Bắc Ninh ','207.png', 2199000, 'Hàng Ngày ', '1 ngày 0 đêm ', 'Hà nội – Bắc Ninh – Đền Đô ', 'Tour du lịch từ Hà Nội đến Bắc Ninh và Đền Đô là một hành trình hấp dẫn, mang đến trải nghiệm độc đáo của vùng miền Bắc Việt Nam. Khám phá sự hòa quyện giữa hiện đại và truyền thống tại thủ đô Hà Nội, nơi có lịch sử lâu dài và văn hóa đa dạng. Tại Bắc Ninh, du khách sẽ đắm chìm trong không khí bình yên của làng nghề truyền thống. Đến Đền Đô, một di tích lịch sử quan trọng, du khách sẽ khám phá kiến trúc độc đáo và tìm hiểu về câu chuyện lịch sử phong phú của vùng đất này.',50),
    ('Miền Bắc', 1, 'Tam Đảo - Đền Chúa Thượng ','208.png', 7299000, 'Hàng Ngày ', '3 ngày 2 đêm ', 'Tam Đảo - Thác Bạc - Đền Chúa Thượng Ngàn ', 'Hành trình du lịch Tam Đảo - Thác Bạc - Đền Chúa Thượng Ngàn là một chuyến phiêu lưu đầy ắp với vẻ đẹp thiên nhiên hùng vĩ. Bắt đầu tại Tam Đảo, du khách sẽ khám phá thành phố nghỉ dưỡng với khí hậu mát mẻ và những con đường ngoằn nghèo quanh co. Tiếp theo là Thác Bạc, nơi dòng nước trong veo rơi từ độ cao, tạo ra cảnh quan huyền bí. Chuyến đi kết thúc tại Đền Chúa Thượng Ngàn, một ngôi đền linh thiêng với kiến trúc truyền thống, mang lại trải nghiệm tâm linh và tận hưởng vẻ đẹp tự nhiên tuyệt vời.',50),
    ('Miền Bắc', 1, 'Hà Nội - Hạ Long ','209.png', 2799000, 'Hàng Ngày ', '4 ngày 3 đêm ', 'Hà Nội - Hạ Long - Đảo Tuần Châu - Hòn Đinh Hương ', 'Tour du lịch từ Hà Nội đến Hạ Long, Đảo Tuần Châu, và Hòn Đinh Hương là hành trình đầy ấn tượng giữa vẻ đẹp tự nhiên và di sản văn hóa. Khám phá thủ đô lịch sử Hà Nội với kiến trúc cổ kính, sau đó hướng ra Hạ Long, một trong Những Kỳ Quan Thiên Nhiên Thế Giới, nơi bạn sẽ ngạc nhiên trước vịnh biển hùng vĩ. Du khách tiếp tục đến Đảo Tuần Châu, nơi tận hưởng cảnh đẹp tuyệt vời và trải nghiệm hoạt động giải trí thú vị. Hành trình kết thúc ở Hòn Đinh Hương, nơi du khách thư giãn trong không khí yên bình và hòa mình vào huyền bí của vịnh Hạ Long.',50),
    ('Miền Bắc', 1, 'Hà Giang ','210.png', 7899000, 'Mùng 4 Tết ', '3 ngày 2 đêm ', 'Hà Nội - Hà Giang - Sông Nho Quế ', 'Tour du lịch Hà Nội - Hà Giang - Sông Nho Quế là hành trình kỳ vĩ, mang đến trải nghiệm độc đáo giữa vùng thủ đô lịch sự và vùng miền núi hùng vĩ. Tại Hà Nội, du khách sẽ bắt đầu hành trình với những di tích lịch sử, văn hóa đặc sắc. Hành trình tiếp tục đến Hà Giang, nơi mênh mông những cánh đồng hào hùng, đỉnh núi cao vút và đường mòn ngoằn nghèo. Cuối cùng, Sông Nho Quế nối liền tâm hồn du khách với hình ảnh hữu tình của vùng quê tĩnh lặng.',50);
...
INSERT INTO `booking` (`userId`, `date`, `tourId`, `numChildren`, `numAdult`, `name`, `phone`,`email`, `address`,`dateBooking`) VALUES
    (1, '2024-04-01', 1, 2, 3, 'Nguyễn Văn A', '123456789','123@gmail.com', '123 Đường ABC, Quận XYZ','05-15-2024'),
    (2, '2024-04-02', 2, 1, 2, 'Trần Thị B', '987654321','123@gmail.com', '456 Đường XYZ, Quận ABC','23-10-2024'),
    (3, '2024-04-03', 3, 2, 2, 'Phạm Văn C', '456123789','123@gmail.com', '789 Đường XYZ, Quận ABC','17-04-2024');
...
CREATE TABLE `images` (
                          ...
                          `tourId` int(11) NOT NULL,
                          PRIMARY KEY (`id`),
                          CONSTRAINT `fk_tour_image_id` FOREIGN KEY (`tourId`) REFERENCES `tours` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `detailDuration` (
                                  ...
                                  `tourId` int(11) NOT NULL,
                                  PRIMARY KEY (`id`),
                                  CONSTRAINT `fk_tourId_detaildes` FOREIGN KEY (`tourId`) REFERENCES `tours` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
