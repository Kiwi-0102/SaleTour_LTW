...
VALUES
    ...
    ('Miền Nam', 1, 'Đồng Tháp - Mộc Hóa', '3.jpg', 6790000,@start_time, '4 ngày 3 đêm', 'Ngày 1: Đến Đồng Tháp - Ngày 2: Khám phá Đồng Tháp - Ngày 3: Đi Mộc Hóa - Ngày 4: Trở về thành phố Hồ Chí Minh', 'Tour Đồng Tháp - Mộc Hóa là chuyến hành trình để khám phá hai điểm đến hấp dẫn ở miền Nam Việt Nam.',50),
    ...
    ('Miền Nam', 1, 'Tiền Giang - Cai Lậy', '9.jpg', 3590000,@start_time, '3 ngày 2 đêm', 'Ngày 1: Đến Tiền Giang - Ngày 2: Khám phá Cái Lậy - Ngày 3: Trở về thành phố Hồ Chí Minh', 'Tour Tiền Giang - Cái Lậy là một hành trình khám phá vùng đồng bằng sông nước phong cảnh tại miền Nam Việt Nam. ',50),
    ('Miền Nam', 1, 'Bình Dương - Suối Tiên', '10.jpg', 4490000,@start_time, '4 ngày 3 đêm', 'Ngày 1: Buổi sáng: Rời khỏi thành phố Hồ Chí Minh và đến Bình Dương - Ngày 2: Buổi sáng: Tham quan Khu du lịch Suối Tiên ở thành phố Hồ Chí Minh - Ngày 3: Buổi sáng: Tham quan Khu du lịch Đại Nam Văn Hiến - Ngày 4: Trở về thành phố Hồ Chí Minh', 'Chuyến đi Bình Dương - Suối Tiên là một hành trình thú vị để khám phá vùng đất Bình Dương và tận hưởng các hoạt động giải trí tại khu du lịch Suối Tiên.',50),
    ...
    ('Miền Nam', 1, 'Tp Hồ Chí Minh - Vũng Tàu', '14.jpg', 5967000,@start_time, '4 ngày 3 đêm', 'Ngày 1: . . . - Ngày 2: . . .  - Ngày 3: . . . - Ngày 4: . . .', 'Vũng Tàu là một thành phố ven biển nằm ở miền Nam Việt Nam, được biết đến với bãi biển đẹp và không khí biển trong lành.',50),
    ...
    ('Miền Nam', 1, 'Tiền Giang - Tân Phong', '20.jpg', 3520000,@start_time, '3 ngày 2 đêm', 'Ngày 1: . . . - Ngày 2: . . .  - Ngày 3: . . .', 'Tour Tiền Giang là một hành trình khám phá vùng đồng bằng sông nước phong cảnh tại miền Nam Việt Nam. ',50),
    ...
    ('Miền Nam', 1, 'Tiền Giang - Cù lao Thới Sơn', '36.jpg', 5000000,@start_time, '2 ngày 1 đêm', 'Ngày 1: . . . - Ngày 2: . . . ', 'Tour Tiền Giang là một hành trình khám phá vùng đồng bằng sông nước phong cảnh tại miền Nam Việt Nam. ',50),
...
-- 71-140
    ...
    ('Miền Trung', 1, 'Huế - Đà Nẵng', '90.png', 2990000,@start_time, '3 ngày 3 đêm', 'Ngày 1: Huế- Ngày 2: Chùa Thiện Mụ- Ngày 3: Đà Nẵng','Huế là một nơi tuyệt đẹp',50),
    ...
    ('Miền Trung', 1, 'Đà Nẵng - Đà Lạt', '109.jpg', 5990000,@start_time, '6 ngày 5 đêm', 'Ngày 1: Đà Nẵng- Ngày 2: Ngũ Hành Sơn- Ngày 3: Bà Nà Hills -Ngày 4: Thác Datanla- Ngày 5: Đà Nẵng- Ngày 6: Đà Lạt '
    ,' chuyến du lịch từ Đà Nẵng tới Đà Lạt sẽ mang đến cho du khách những điểm đến du lịch nổi tiếng ở miền Trung Việt Nam với vẻ đẹp tự nhiên, văn hóa độc đáo và ẩm thực hấp dẫn.',50),
    ...
    ('Miền Trung', 1, 'Huế - Đà Nẵng', '111.jpg', 5990000,@start_time, '6 ngày 5 đêm', 'Ngày 1: Huế- Ngày 2: Chùa Thiên Mụ- Ngày 3: Động Thiên Đường -Ngày 4: Phong Nha- Ngày 5: Kẻ Bằng- Ngày 6: Đà Nẵng'
    ,' chuyến du lịch từ Huế tới Đà Nẵng sẽ mang đến cho du khách những điểm đến du lịch nổi tiếng ở miền Trung Việt Nam với vẻ đẹp tự nhiên, văn hóa độc đáo và ẩm thực hấp dẫn.',50),
    ...
    ('Miền Trung', 1, 'Huế - Đà Lạt', '113.jpg', 5990000,@start_time, '6 ngày 5 đêm', 'Ngày 1: Huế- Ngày 2: Chùa Thiên Mụ- Ngày 3: Động Thiên Đường -Ngày 4: Thác Datanla- Ngày 5:chợ Đà Lạt- Ngày 6: Đà Lạt'
    ,' chuyến du lịch từ Huế tới Đà Lạt sẽ mang đến cho du khách những điểm đến du lịch nổi tiếng ở miền Trung Việt Nam với vẻ đẹp tự nhiên, văn hóa độc đáo và ẩm thực hấp dẫn.',50),
    ...
    ('Miền Trung', 1, 'Đà Lạt - Nha Trang', '118.jpg', 5990000,@start_time, '6 ngày 5 đêm', 'Ngày 1: Đà Lạt- Ngày 2: chợ Đà Lạt- Ngày 3: Thác Datanla -Ngày 4: Thác Datanla- Ngày 5:Vinpearl Land- Ngày 6: Nha Trang'
    ,' chuyến du lịch từ Đà Lạt tới Nha Trang sẽ mang đến cho du khách những điểm đến du lịch nổi tiếng ở miền Trung Việt Nam với vẻ đẹp tự nhiên, văn hóa độc đáo và ẩm thực hấp dẫn.',50),
...
-- 141 -->210----------------------------------->
    ...
    ('Miền Bắc', 1, 'Hà Nội - Tràng An ','154.png', 4999000,@start_time, '4 ngày 3 đêm ', 'Hà Nội - Tràng An - Sapa - Bản Cát Cát ', 'Hành trình du lịch này mang đến cho bạn trải nghiệm tuyệt vời qua những điểm đẹp độc đáo tại Việt Nam. Bắt đầu từ thủ đô lịch sử Hà Nội, bạn sẽ khám phá văn hóa độc đáo tại Tràng An, một di sản thế giới nổi tiếng. Tiếp theo là hành trình đến Sapa, nơi có những thửa ruộng bậc thang hùng vĩ. Cuối cùng, Bản Cát Cát sẽ là điểm dừng cuối cùng, nơi bạn có cơ hội tìm hiểu về đời sống và văn hóa của người dân tộc thiểu số tại vùng núi phía Bắc.',50),
    ...
    ('Miền Bắc', 1, 'Sapa - Fanxipan','170.png', 4299000,@start_time, '4 ngày 3 đêm ', 'Sapa - Cát Cát - Hàm Rồng - Fanxipan ', 'Hành trình du lịch khám phá vùng núi Tây Bắc tại Sapa sẽ đưa du khách đến những địa điểm tuyệt vời như thác Cát Cát hùng vĩ, làng Hàm Rồng truyền thống của dân tộc HMông, và đỉnh núi Fanxipan - "Rồng của Đông Dương". Trải nghiệm độc đáo này mang đến không khí trong lành, khám phá văn hóa độc đáo và cảm nhận vẻ đẹp huyền bí của núi rừng nơi đỉnh cao nhất Việt Nam.',50),
    ...
    ('Miền Bắc', 1, 'Hà Nội - chùa Tây Phương ','206.png', 3999000,@start_time, '1 ngày 0 đêm ', 'Hà Nội – chùa Thầy – Chùa Tây Phương', 'Hành trình du lịch này đưa du khách khám phá những địa điểm tâm linh tại miền Bắc Việt Nam. Từ Hà Nội, thành phố với vẻ đẹp hài hòa giữa nét cổ kính và hiện đại, du khách sẽ bắt đầu hành trình đến Chùa Thầy - nơi linh thiêng, trùng Hiếu khí tựa như thiên đàng hình trần. Tiếp theo là Chùa Tây Phương, điểm đến với kiến trúc độc đáo và tượng Phật đồ sộ. Tour du lịch này hứa hẹn mang đến trải nghiệm tâm linh và khám phá văn hóa độc đáo của miền Bắc.',50),
