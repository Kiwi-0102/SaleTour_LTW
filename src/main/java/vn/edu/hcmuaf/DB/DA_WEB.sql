...
-- 71-140
    ...
    ('Miền Trung', 1, 'Huế - Đà Nẵng', '90.png', 2990000, 'hằng ngày', '3 ngày 3 đêm', 'Ngày 1: Huế- Ngày 2: Chùa Thiện Mụ- Ngày 3: Đà Nẵng','Huế là một nơi tuyệt đẹp'),
...
-- 141 -->210----------------------------------->
    ...
    ('Miền Bắc', 1, 'Sapa - Fanxipan','170.png', 4299000, 'Hàng Ngày ', '4 ngày 3 đêm ', 'Sapa - Cát Cát - Hàm Rồng - Fanxipan ', 'Hành trình du lịch khám phá vùng núi Tây Bắc tại Sapa sẽ đưa du khách đến những địa điểm tuyệt vời như thác Cát Cát hùng vĩ, làng Hàm Rồng truyền thống của dân tộc HMông, và đỉnh núi Fanxipan - "Rồng của Đông Dương". Trải nghiệm độc đáo này mang đến không khí trong lành, khám phá văn hóa độc đáo và cảm nhận vẻ đẹp huyền bí của núi rừng nơi đỉnh cao nhất Việt Nam.'),
    ...
    ('Miền Bắc', 1, 'Hà Nội - chùa Tây Phương ','206.png', 3999000, 'Hàng Ngày ', '1 ngày 0 đêm ', 'Hà Nội – chùa Thầy – Chùa Tây Phương', 'Hành trình du lịch này đưa du khách khám phá những địa điểm tâm linh tại miền Bắc Việt Nam. Từ Hà Nội, thành phố với vẻ đẹp hài hòa giữa nét cổ kính và hiện đại, du khách sẽ bắt đầu hành trình đến Chùa Thầy - nơi linh thiêng, trùng Hiếu khí tựa như thiên đàng hình trần. Tiếp theo là Chùa Tây Phương, điểm đến với kiến trúc độc đáo và tượng Phật đồ sộ. Tour du lịch này hứa hẹn mang đến trải nghiệm tâm linh và khám phá văn hóa độc đáo của miền Bắc.'),
