...
<%
    ...
    ArrayList<Booking> choxacnhan = (ArrayList<Booking>) request.getAttribute("listTour");
    long doanhthu = (long) request.getAttribute("doanhthu");
        ...
        <div class="manager-checkout" style="width: 98%">
            ...
            <div class="container">
                <div class="box red-box">
                    <div class="text invalid" style="margin-left: 15px" id="textinvalidsdsđs">Tổng lợi nhuận:<%=df1.format(doanhthu)%>
                    </div>
                </div>
                    ...
                    <div id="tab1" class="tabcontent">
                        <table id="table-id-1" class="table table-hover table-bordered">
                            ...
                            <tr id="<%=bill.getId()%>">
                                ...
                                <td>
                                    <a href="BillDetailAdmin?id=1"><%=bill.getNumAdult() + bill.getNumChildren()%>
                                    </a>
                                </td>
                                <td >
                                    <%=bill.getDateStart()%>
                                </td>
                                <td><%=df1.format((bill.getNumAdult() + bill.getNumChildren()*0.6)*TourDao.findtourbyid(bill.getTourId()).getPrice())%>
                                </td>
                                <td>
